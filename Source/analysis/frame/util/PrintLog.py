...
class PrintLog:
    ...
    def PrintModelInfo(self, Model):
        ...
        tOutput += "\t" + "NUM. OF MEMBERS...................................... = " + str(Model.Member.Count) + '\n'
        ...
        for ii in Model.Material.ID:
            tOutput += "\t" + "ID = " + str(int(ii)).zfill(3) + "; " + "E = " + str(format(Model.Material.E[ii], "0.4e")) + "; "\
                    + "G = " + str(format(Model.Material.G[ii], "0.4e")) + "; " + "FY = " + str(format(Model.Material.Fy[ii], "0.4e")) + "; "\
        ...
        for ii in Model.Section.ID:
            ...
            tOutput += "\t" + "MAT. ID = " + str(int(Model.Section.MatID[ii])).zfill(3) + "; " + "A = " + str(format(Model.Section.A[ii], "0.4e")) + "; "\
                    + "Iy = " + str(format(Model.Section.Iy[ii], "0.4e")) + "; " + "Iz = " + str(format(Model.Section.Iz[ii], "0.4e")) + "; "\
                    + "J = " + str(format(Model.Section.J[ii], "0.4e")) + "; " + '\n'
            tOutput +="\t" + "Cw = " + str(format(Model.Section.Cw[ii], "0.4e")) + "; " + "yc = " + str(format(Model.Section.yc[ii], "0.4e")) + "; " \
                    + "zc = " + str(format(Model.Section.zc[ii], "0.4e")) + "; " + "ky = " + str(format(Model.Section.ky[ii], "0.4e")) + "; " \
                    + "kz = " + str(format(Model.Section.kz[ii], "0.4e")) + "; " + '\n'
            tOutput += "\t" + "betay = " + str(format(Model.Section.betay[ii], "0.4e")) + "; " + "betaz = " + str(format(Model.Section.betaz[ii], "0.4e")) + "; "\
                    + "betaw = " + str(format(Model.Section.betaw[ii], "0.4e")) + "; " + '\n'
            tOutput += "\t\t" + '\n'
        ...
        tOutput += "\t\t" + '\n'
        tOutput += "* MEMBER CONNECTIVITY" + '\n'
        tOutput += "\t" + "ID." + "\t\t" + "SECT." + "\t\t" + "NODE I" + "\t\t" + "NODE J" + "\t\t" + "BETA" + '\n'
        for ii in Model.Member.ID:
            tOutput += "\t" + str(int(ii)) + "\t\t" + str(int(Model.Member.SectID[ii])) + "\t\t\t" \
                       + str(int(Model.Member.I[ii])) + "\t\t\t" + str(int(Model.Member.J[ii])) + "\t\t\t" \
                       + str(format(Model.Member.Beta[ii], "0.4e")) + '\n'
