...
################################################################################
## Form generated from reading UI file 'BuldTee.ui'
##
...
class Ui_BuldTee_Dialog(object):
    def setupUi(self, BuldTee_Dialog):
        if not BuldTee_Dialog.objectName():
            BuldTee_Dialog.setObjectName(u"BuldTee_Dialog")
        BuldTee_Dialog.resize(540, 533)
        BuldTee_Dialog.setMinimumSize(QSize(540, 529))
        BuldTee_Dialog.setMaximumSize(QSize(540, 533))
        BuldTee_Dialog.setStyleSheet(u"*{	\n"
"	color: rgb(255, 255, 255);\n"
"	font: 9pt \"Segoe UI\";\n"
"	background-color: rgb(43, 43, 43);\n"
"}\n"
"")
        self.gridLayout_3 = QGridLayout(BuldTee_Dialog)
        ...
        self.label = QLabel(BuldTee_Dialog)
        ...
        self.ModelingType_groupBox = QGroupBox(BuldTee_Dialog)
        ...
        self.Dimension_groupBox = QGroupBox(BuldTee_Dialog)
...
"")
        ...
        self.B4_inputlineEdit = QLineEdit(self.Dimension_groupBox)
        self.B4_inputlineEdit.setObjectName(u"B4_inputlineEdit")
        self.B4_inputlineEdit.setStyleSheet(u"*{	\n"
"	font: 9pt \"Segoe UI\";\n"
"	color: rgb(0, 0, 0);\n"
"	background: rgb(255, 255, 255);\n"
"}\n"
"")
        ...
        self.formLayout.setWidget(3, QFormLayout.FieldRole, self.B4_inputlineEdit)
...
"")
        ...
        self.label_10 = QLabel(self.Dimension_groupBox)
...
"")
        ...
        self.D5_inputlineEdit = QLineEdit(self.Dimension_groupBox)
        self.D5_inputlineEdit.setObjectName(u"D5_inputlineEdit")
        self.D5_inputlineEdit.setStyleSheet(u"*{	\n"
"	font: 9pt \"Segoe UI\";\n"
"	color: rgb(0, 0, 0);\n"
"	background: rgb(255, 255, 255);\n"
"}\n"
"")
        ...
        self.formLayout.setWidget(8, QFormLayout.FieldRole, self.D5_inputlineEdit)
...
"")
        ...
        self.formLayout.setWidget(9, QFormLayout.FieldRole, self.D_inputlineEdit)
        ...
        self.IShape_groupBox = QGroupBox(BuldTee_Dialog)
...
"")
        ...
        self.button_GroupBox = QGroupBox(BuldTee_Dialog)
...
"}")
        ...
        QWidget.setTabOrder(self.B3_inputlineEdit, self.B4_inputlineEdit)
        QWidget.setTabOrder(self.B4_inputlineEdit, self.D1_inputlineEdit)
        ...
        QWidget.setTabOrder(self.D4_inputlineEdit, self.D5_inputlineEdit)
        QWidget.setTabOrder(self.D5_inputlineEdit, self.D_inputlineEdit)
        ...
        self.retranslateUi(BuldTee_Dialog)

        QMetaObject.connectSlotsByName(BuldTee_Dialog)
    # setupUi

    def retranslateUi(self, BuldTee_Dialog):
        BuldTee_Dialog.setWindowTitle(QCoreApplication.translate("BuldTee_Dialog", u"Buld Tee - Template", None))
        self.label.setText("")
        self.ModelingType_groupBox.setTitle(QCoreApplication.translate("BuldTee_Dialog", u"Modeling Type", None))
        self.Centerline_radioButton.setText(QCoreApplication.translate("BuldTee_Dialog", u"Centerline", None))
        self.Outline_radioButton.setText(QCoreApplication.translate("BuldTee_Dialog", u"Outline", None))
        self.Dimension_groupBox.setTitle(QCoreApplication.translate("BuldTee_Dialog", u"Dimension", None))
        self.B_label.setText(QCoreApplication.translate("BuldTee_Dialog", u"B1 = ", None))
        self.tw_label.setText(QCoreApplication.translate("BuldTee_Dialog", u"B2 = ", None))
        self.label_2.setText(QCoreApplication.translate("BuldTee_Dialog", u"B3 = ", None))
        self.label_3.setText(QCoreApplication.translate("BuldTee_Dialog", u"B4 = ", None))
        self.label_5.setText(QCoreApplication.translate("BuldTee_Dialog", u"D1 = ", None))
        self.label_6.setText(QCoreApplication.translate("BuldTee_Dialog", u"D2 = ", None))
        self.label_7.setText(QCoreApplication.translate("BuldTee_Dialog", u"D3 = ", None))
        self.label_10.setText(QCoreApplication.translate("BuldTee_Dialog", u"D4 = ", None))
        self.label_8.setText(QCoreApplication.translate("BuldTee_Dialog", u"D5 = ", None))
        self.label_9.setText(QCoreApplication.translate("BuldTee_Dialog", u"D = ", None))
        self.IShape_groupBox.setTitle(QCoreApplication.translate("BuldTee_Dialog", u"Material", None))
        self.G_label.setText(QCoreApplication.translate("BuldTee_Dialog", u" E  = ", None))
        self.ID_label.setText(QCoreApplication.translate("BuldTee_Dialog", u"Color = ", None))
        self.E_label.setText(QCoreApplication.translate("BuldTee_Dialog", u"ID = ", None))
        self.fy_label.setText(QCoreApplication.translate("BuldTee_Dialog", u"fy  = ", None))
        self.Color_label.setText(QCoreApplication.translate("BuldTee_Dialog", u"     \u03bc   = ", None))
        self.eu_label.setText(QCoreApplication.translate("BuldTee_Dialog", u"eu = ", None))
        self.ColorButton.setText("")
        self.OK_button.setText(QCoreApplication.translate("BuldTee_Dialog", u"OK", None))
        self.Cancel_pushButton.setText(QCoreApplication.translate("BuldTee_Dialog", u"Cancel", None))
    # retranslateUi
