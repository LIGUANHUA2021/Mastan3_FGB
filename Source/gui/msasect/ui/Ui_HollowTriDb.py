# Form implementation generated from reading ui file 'HollowTriDb.ui'
#
...
class Ui_HollowTriDb_Dialog(object):
    def setupUi(self, HollowTriDb_Dialog):
        HollowTriDb_Dialog.setObjectName("HollowTriDb_Dialog")
        HollowTriDb_Dialog.resize(447, 561)
        HollowTriDb_Dialog.setStyleSheet("*{    \n"
"    color: rgb(255, 255, 255);\n"
"    font: 9pt \"Segoe UI\";\n"
"    background-color: rgb(43, 43, 43);\n"
"}\n"
"")
        self.verticalLayout = QtWidgets.QVBoxLayout(HollowTriDb_Dialog)
        ...
        self.CSection_groupBox = QtWidgets.QGroupBox(HollowTriDb_Dialog)
...
"")
        ...
        self.groupBox = QtWidgets.QGroupBox(HollowTriDb_Dialog)
...
"}")
        ...
        self.retranslateUi(HollowTriDb_Dialog)
        QtCore.QMetaObject.connectSlotsByName(HollowTriDb_Dialog)

    def retranslateUi(self, HollowTriDb_Dialog):
        _translate = QtCore.QCoreApplication.translate
        HollowTriDb_Dialog.setWindowTitle(_translate("HollowTriDb_Dialog", "HollowTriangle - Database"))
        self.CSection_groupBox.setTitle(_translate("HollowTriDb_Dialog", "Database"))
        self.ComboBox.setItemText(0, _translate("HollowTriDb_Dialog", "User-Triangle(mm)"))
        self.ComboBox.setItemText(1, _translate("HollowTriDb_Dialog", "User-Triangle(in)"))
        self.groupBox_3.setTitle(_translate("HollowTriDb_Dialog", "Section name:"))
        self.groupBox_2.setTitle(_translate("HollowTriDb_Dialog", "Dimensions:"))
        self.OK_button.setText(_translate("HollowTriDb_Dialog", "OK"))
        self.Cancel_pushButton.setText(_translate("HollowTriDb_Dialog", "Cancel"))
