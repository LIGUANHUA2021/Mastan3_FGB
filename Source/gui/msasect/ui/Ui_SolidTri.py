...
################################################################################
## Form generated from reading UI file 'SolidTri.ui'
##
...
class Ui_SolidTri_Dialog(object):
    def setupUi(self, SolidTri_Dialog):
        if not SolidTri_Dialog.objectName():
            SolidTri_Dialog.setObjectName(u"SolidTri_Dialog")
        SolidTri_Dialog.resize(540, 533)
        SolidTri_Dialog.setMinimumSize(QSize(540, 529))
        SolidTri_Dialog.setMaximumSize(QSize(540, 533))
        SolidTri_Dialog.setStyleSheet(u"*{	\n"
"	color: rgb(255, 255, 255);\n"
"	font: 9pt \"Segoe UI\";\n"
"	background-color: rgb(43, 43, 43);\n"
"}\n"
"")
        self.gridLayout_3 = QGridLayout(SolidTri_Dialog)
        ...
        self.label = QLabel(SolidTri_Dialog)
        ...
        self.ModelingType_groupBox = QGroupBox(SolidTri_Dialog)
        ...
        self.Dimension_groupBox = QGroupBox(SolidTri_Dialog)
...
"")
        ...
        self.formLayout.setWidget(1, QFormLayout.FieldRole, self.B1_inputlineEdit)
        ...
        self.SolidTri_groupBox = QGroupBox(SolidTri_Dialog)
        self.SolidTri_groupBox.setObjectName(u"SolidTri_groupBox")
        self.SolidTri_groupBox.setMinimumSize(QSize(0, 80))
        self.SolidTri_groupBox.setStyleSheet(u"color: rgb(255, 255, 255);\n"
"background-color: rgb(128, 128, 128);")
        self.gridLayout_2 = QGridLayout(self.SolidTri_groupBox)
...
"")
        ...
        self.fy_inputlineEdit = QLineEdit(self.SolidTri_groupBox)
...
"")
        ...
        self.eu_label = QLabel(self.SolidTri_groupBox)
        self.eu_label.setObjectName(u"eu_label")

        self.gridLayout.addWidget(self.eu_label, 1, 4, 1, 1)

        self.G_inputlineEdit = QLineEdit(self.SolidTri_groupBox)
...
"")
        ...
        self.E_inputlineEdit = QLineEdit(self.SolidTri_groupBox)
...
"")
        ...
        self.ID_inputlineEdit = QLineEdit(self.SolidTri_groupBox)
...
"")
        ...
        self.ColorButton = QPushButton(self.SolidTri_groupBox)
...
"")
        ...
        self.gridLayout_3.addWidget(self.SolidTri_groupBox, 0, 0, 1, 1)

        self.button_GroupBox = QGroupBox(SolidTri_Dialog)
...
"")
        ...
        QWidget.setTabOrder(self.B_inputlineEdit, self.B1_inputlineEdit)
        QWidget.setTabOrder(self.B1_inputlineEdit, self.D_inputlineEdit)
        ...
        self.retranslateUi(SolidTri_Dialog)

        QMetaObject.connectSlotsByName(SolidTri_Dialog)
    # setupUi

    def retranslateUi(self, SolidTri_Dialog):
        SolidTri_Dialog.setWindowTitle(QCoreApplication.translate("SolidTri_Dialog", u"Solid Triangle - Template", None))
        self.label.setText("")
        self.ModelingType_groupBox.setTitle(QCoreApplication.translate("SolidTri_Dialog", u"Modeling Type", None))
        self.Centerline_radioButton.setText(QCoreApplication.translate("SolidTri_Dialog", u"Centerline", None))
        self.Outline_radioButton.setText(QCoreApplication.translate("SolidTri_Dialog", u"Outline", None))
        self.Dimension_groupBox.setTitle(QCoreApplication.translate("SolidTri_Dialog", u"Dimension", None))
        self.B_label.setText(QCoreApplication.translate("SolidTri_Dialog", u"B = ", None))
        self.tw_label.setText(QCoreApplication.translate("SolidTri_Dialog", u"D = ", None))
        self.label_2.setText(QCoreApplication.translate("SolidTri_Dialog", u"B1 = ", None))
        self.SolidTri_groupBox.setTitle(QCoreApplication.translate("SolidTri_Dialog", u"Material", None))
        self.G_label.setText(QCoreApplication.translate("SolidTri_Dialog", u" E  = ", None))
        self.ID_label.setText(QCoreApplication.translate("SolidTri_Dialog", u"Color = ", None))
        self.E_label.setText(QCoreApplication.translate("SolidTri_Dialog", u"ID = ", None))
        self.fy_label.setText(QCoreApplication.translate("SolidTri_Dialog", u"fy  = ", None))
        self.Color_label.setText(QCoreApplication.translate("SolidTri_Dialog", u"     \u03bc   = ", None))
        self.eu_label.setText(QCoreApplication.translate("SolidTri_Dialog", u"eu = ", None))
        self.ColorButton.setText("")
        self.OK_button.setText(QCoreApplication.translate("SolidTri_Dialog", u"OK", None))
        self.Cancel_pushButton.setText(QCoreApplication.translate("SolidTri_Dialog", u"Cancel", None))
    # retranslateUi
