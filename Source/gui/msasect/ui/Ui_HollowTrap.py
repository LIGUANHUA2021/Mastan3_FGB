...
################################################################################
## Form generated from reading UI file 'HollowTrap.ui'
##
...
class Ui_HollowTrap_Dialog(object):
    def setupUi(self, HollowTrap_Dialog):
        if not HollowTrap_Dialog.objectName():
            HollowTrap_Dialog.setObjectName(u"HollowTrap_Dialog")
        HollowTrap_Dialog.resize(540, 533)
        HollowTrap_Dialog.setMinimumSize(QSize(540, 533))
        HollowTrap_Dialog.setMaximumSize(QSize(540, 533))
        HollowTrap_Dialog.setStyleSheet(u"*{	\n"
"	color: rgb(255, 255, 255);\n"
"	font: 9pt \"Segoe UI\";\n"
"	background-color: rgb(43, 43, 43);\n"
"}\n"
"")
        self.gridLayout_3 = QGridLayout(HollowTrap_Dialog)
        ...
        self.label = QLabel(HollowTrap_Dialog)
        ...
        self.ModelingType_groupBox = QGroupBox(HollowTrap_Dialog)
        ...
        self.Dimension_groupBox = QGroupBox(HollowTrap_Dialog)
...
"")
        ...
        self.formLayout.setWidget(4, QFormLayout.LabelRole, self.tw_label)

        self.tf1_inputlineEdit = QLineEdit(self.Dimension_groupBox)
        self.tf1_inputlineEdit.setObjectName(u"tf1_inputlineEdit")
        self.tf1_inputlineEdit.setStyleSheet(u"*{	\n"
"	font: 9pt \"Segoe UI\";\n"
"	color: rgb(0, 0, 0);\n"
"	background: rgb(255, 255, 255);\n"
"}\n"
"")
        ...
        self.formLayout.setWidget(4, QFormLayout.FieldRole, self.tf1_inputlineEdit)

        self.k_label = QLabel(self.Dimension_groupBox)
        self.k_label.setObjectName(u"k_label")

        self.formLayout.setWidget(5, QFormLayout.LabelRole, self.k_label)

        self.tf2_inputlineEdit = QLineEdit(self.Dimension_groupBox)
        self.tf2_inputlineEdit.setObjectName(u"tf2_inputlineEdit")
        self.tf2_inputlineEdit.setStyleSheet(u"*{	\n"
"	font: 9pt \"Segoe UI\";\n"
"	color: rgb(0, 0, 0);\n"
"	background: rgb(255, 255, 255);\n"
"}\n"
"")
        ...
        self.formLayout.setWidget(5, QFormLayout.FieldRole, self.tf2_inputlineEdit)
...
"")
        ...
        self.HollowTrap_groupBox = QGroupBox(HollowTrap_Dialog)
        self.HollowTrap_groupBox.setObjectName(u"HollowTrap_groupBox")
        self.HollowTrap_groupBox.setMinimumSize(QSize(0, 80))
        self.HollowTrap_groupBox.setStyleSheet(u"color: rgb(255, 255, 255);\n"
"background-color: rgb(128, 128, 128);")
        self.gridLayout_2 = QGridLayout(self.HollowTrap_groupBox)
...
"")
        ...
        self.fy_inputlineEdit = QLineEdit(self.HollowTrap_groupBox)
...
"")
        ...
        self.eu_label = QLabel(self.HollowTrap_groupBox)
        self.eu_label.setObjectName(u"eu_label")

        self.gridLayout.addWidget(self.eu_label, 1, 4, 1, 1)

        self.G_inputlineEdit = QLineEdit(self.HollowTrap_groupBox)
...
"")
        ...
        self.E_inputlineEdit = QLineEdit(self.HollowTrap_groupBox)
...
"")
        ...
        self.ID_inputlineEdit = QLineEdit(self.HollowTrap_groupBox)
...
"")
        ...
        self.ColorButton = QPushButton(self.HollowTrap_groupBox)
...
"")
        ...
        self.gridLayout_3.addWidget(self.HollowTrap_groupBox, 0, 0, 1, 1)

        self.button_GroupBox = QGroupBox(HollowTrap_Dialog)
...
"")
        ...
        QWidget.setTabOrder(self.tw_inputlineEdit, self.tf1_inputlineEdit)
        QWidget.setTabOrder(self.tf1_inputlineEdit, self.tf2_inputlineEdit)
        QWidget.setTabOrder(self.tf2_inputlineEdit, self.OK_button)
        ...
        self.retranslateUi(HollowTrap_Dialog)

        QMetaObject.connectSlotsByName(HollowTrap_Dialog)
    # setupUi

    def retranslateUi(self, HollowTrap_Dialog):
        HollowTrap_Dialog.setWindowTitle(QCoreApplication.translate("HollowTrap_Dialog", u"Hollow Trapezoid - Template", None))
        self.label.setText("")
        self.ModelingType_groupBox.setTitle(QCoreApplication.translate("HollowTrap_Dialog", u"Modeling Type", None))
        self.Centerline_radioButton.setText(QCoreApplication.translate("HollowTrap_Dialog", u"Centerline", None))
        self.Outline_radioButton.setText(QCoreApplication.translate("HollowTrap_Dialog", u"Outline", None))
        self.Dimension_groupBox.setTitle(QCoreApplication.translate("HollowTrap_Dialog", u"Dimension", None))
        self.B_label.setText(QCoreApplication.translate("HollowTrap_Dialog", u"B1 = ", None))
        self.D_label.setText(QCoreApplication.translate("HollowTrap_Dialog", u"D = ", None))
        self.tf_label.setText(QCoreApplication.translate("HollowTrap_Dialog", u"tw = ", None))
        self.tw_label.setText(QCoreApplication.translate("HollowTrap_Dialog", u"tf1 = ", None))
        self.k_label.setText(QCoreApplication.translate("HollowTrap_Dialog", u"tf2 = ", None))
        self.label_2.setText(QCoreApplication.translate("HollowTrap_Dialog", u"B2 =", None))
        self.HollowTrap_groupBox.setTitle(QCoreApplication.translate("HollowTrap_Dialog", u"Material", None))
        self.G_label.setText(QCoreApplication.translate("HollowTrap_Dialog", u" E  = ", None))
        self.ID_label.setText(QCoreApplication.translate("HollowTrap_Dialog", u"Color = ", None))
        self.E_label.setText(QCoreApplication.translate("HollowTrap_Dialog", u"ID = ", None))
        self.fy_label.setText(QCoreApplication.translate("HollowTrap_Dialog", u"fy  = ", None))
        self.Color_label.setText(QCoreApplication.translate("HollowTrap_Dialog", u"     \u03bc   = ", None))
        self.eu_label.setText(QCoreApplication.translate("HollowTrap_Dialog", u"eu = ", None))
        self.ColorButton.setText("")
        self.Import_pushButton.setText(QCoreApplication.translate("HollowTrap_Dialog", u"Import", None))
        self.OK_button.setText(QCoreApplication.translate("HollowTrap_Dialog", u"OK", None))
        self.Cancel_pushButton.setText(QCoreApplication.translate("HollowTrap_Dialog", u"Cancel", None))
    # retranslateUi
