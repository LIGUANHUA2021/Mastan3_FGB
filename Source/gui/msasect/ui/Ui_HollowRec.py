...
################################################################################
## Form generated from reading UI file 'HollowRec.ui'
##
...
class Ui_HollowRec_Dialog(object):
    def setupUi(self, HollowRec_Dialog):
        if not HollowRec_Dialog.objectName():
            HollowRec_Dialog.setObjectName(u"HollowRec_Dialog")
        HollowRec_Dialog.resize(540, 533)
        HollowRec_Dialog.setMinimumSize(QSize(540, 533))
        HollowRec_Dialog.setMaximumSize(QSize(540, 533))
        HollowRec_Dialog.setStyleSheet(u"*{	\n"
"	color: rgb(255, 255, 255);\n"
"	font: 9pt \"Segoe UI\";\n"
"	background-color: rgb(43, 43, 43);\n"
"}\n"
"")
        self.gridLayout_3 = QGridLayout(HollowRec_Dialog)
        ...
        self.horizontalLayout_2.setContentsMargins(0, 2, 1, 2)
        self.label = QLabel(HollowRec_Dialog)
        ...
        self.ModelingType_groupBox = QGroupBox(HollowRec_Dialog)
        ...
        self.Dimension_groupBox = QGroupBox(HollowRec_Dialog)
...
"")
        ...
        self.formLayout.setWidget(3, QFormLayout.LabelRole, self.k_label)

        self.tf_inputlineEdit = QLineEdit(self.Dimension_groupBox)
        self.tf_inputlineEdit.setObjectName(u"tf_inputlineEdit")
        self.tf_inputlineEdit.setMinimumSize(QSize(78, 0))
...
"")
        ...
        self.k_inputlineEdit.setMinimumSize(QSize(78, 0))
...
"")
        ...
        self.HollowRec_groupBox = QGroupBox(HollowRec_Dialog)
        self.HollowRec_groupBox.setObjectName(u"HollowRec_groupBox")
        self.HollowRec_groupBox.setMinimumSize(QSize(0, 80))
        self.HollowRec_groupBox.setStyleSheet(u"color: rgb(255, 255, 255);\n"
"background-color: rgb(128, 128, 128);")
        self.gridLayout_2 = QGridLayout(self.HollowRec_groupBox)
...
"")
        ...
        self.fy_inputlineEdit = QLineEdit(self.HollowRec_groupBox)
...
"")
        ...
        self.eu_label = QLabel(self.HollowRec_groupBox)
        self.eu_label.setObjectName(u"eu_label")

        self.gridLayout.addWidget(self.eu_label, 1, 4, 1, 1)

        self.G_inputlineEdit = QLineEdit(self.HollowRec_groupBox)
...
"")
        ...
        self.E_inputlineEdit = QLineEdit(self.HollowRec_groupBox)
...
"")
        ...
        self.ID_inputlineEdit = QLineEdit(self.HollowRec_groupBox)
...
"")
        ...
        self.ColorButton = QPushButton(self.HollowRec_groupBox)
...
"")
        ...
        self.gridLayout_3.addWidget(self.HollowRec_groupBox, 0, 0, 1, 1)

        self.button_GroupBox = QGroupBox(HollowRec_Dialog)
...
"")
        ...
        QWidget.setTabOrder(self.tw_inputlineEdit, self.tf_inputlineEdit)
        QWidget.setTabOrder(self.tf_inputlineEdit, self.k_inputlineEdit)
        QWidget.setTabOrder(self.k_inputlineEdit, self.ColorButton)
        ...
        self.retranslateUi(HollowRec_Dialog)

        QMetaObject.connectSlotsByName(HollowRec_Dialog)
    # setupUi

    def retranslateUi(self, HollowRec_Dialog):
        HollowRec_Dialog.setWindowTitle(QCoreApplication.translate("HollowRec_Dialog", u"Hollow Rectangle - Template", None))
        self.label.setText("")
        self.ModelingType_groupBox.setTitle(QCoreApplication.translate("HollowRec_Dialog", u"Modeling Type", None))
        self.Centerline_radioButton.setText(QCoreApplication.translate("HollowRec_Dialog", u"Centerline", None))
        self.Outline_radioButton.setText(QCoreApplication.translate("HollowRec_Dialog", u"Outline", None))
        self.Dimension_groupBox.setTitle(QCoreApplication.translate("HollowRec_Dialog", u"Dimension", None))
        self.B_label.setText(QCoreApplication.translate("HollowRec_Dialog", u"B = ", None))
        self.D_label.setText(QCoreApplication.translate("HollowRec_Dialog", u"D = ", None))
        self.tw_label.setText(QCoreApplication.translate("HollowRec_Dialog", u"tw = ", None))
        self.k_label.setText(QCoreApplication.translate("HollowRec_Dialog", u"tf = ", None))
        self.label_2.setText(QCoreApplication.translate("HollowRec_Dialog", u"k = ", None))
        self.HollowRec_groupBox.setTitle(QCoreApplication.translate("HollowRec_Dialog", u"Material", None))
        self.G_label.setText(QCoreApplication.translate("HollowRec_Dialog", u" E  = ", None))
        self.ID_label.setText(QCoreApplication.translate("HollowRec_Dialog", u"Color = ", None))
        self.E_label.setText(QCoreApplication.translate("HollowRec_Dialog", u"ID = ", None))
        self.fy_label.setText(QCoreApplication.translate("HollowRec_Dialog", u"fy  = ", None))
        self.Color_label.setText(QCoreApplication.translate("HollowRec_Dialog", u"     \u03bc   = ", None))
        self.eu_label.setText(QCoreApplication.translate("HollowRec_Dialog", u"eu = ", None))
        self.ColorButton.setText("")
        self.Import_pushButton.setText(QCoreApplication.translate("HollowRec_Dialog", u"Import", None))
        self.OK_button.setText(QCoreApplication.translate("HollowRec_Dialog", u"OK", None))
        self.Cancel_pushButton.setText(QCoreApplication.translate("HollowRec_Dialog", u"Cancel", None))
    # retranslateUi
