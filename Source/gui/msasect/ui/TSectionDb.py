...
from gui.msasect.ui.Ui_TSectionDb import Ui_TSectionDb_Dialog
...
class TSectionDb_Dialog(QDialog, Ui_TSectionDb_Dialog):
    """
    ...
    def initlize(self):
        self.label.setPixmap(QPixmap("ui/Template/T-Section_Db.jpg"))
