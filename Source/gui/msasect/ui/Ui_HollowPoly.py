...
################################################################################
## Form generated from reading UI file 'HollowPoly.ui'
##
...
class Ui_HollowPoly_Dialog(object):
    def setupUi(self, HollowPoly_Dialog):
        if not HollowPoly_Dialog.objectName():
            HollowPoly_Dialog.setObjectName(u"HollowPoly_Dialog")
        HollowPoly_Dialog.resize(540, 533)
        HollowPoly_Dialog.setMinimumSize(QSize(540, 529))
        HollowPoly_Dialog.setMaximumSize(QSize(540, 533))
        HollowPoly_Dialog.setStyleSheet(u"*{	\n"
"	color: rgb(255, 255, 255);\n"
"	font: 9pt \"Segoe UI\";\n"
"	background-color: rgb(43, 43, 43);\n"
"}\n"
"")
        self.gridLayout_3 = QGridLayout(HollowPoly_Dialog)
        ...
        self.label = QLabel(HollowPoly_Dialog)
        ...
        self.ModelingType_groupBox = QGroupBox(HollowPoly_Dialog)
        ...
        self.Dimension_groupBox = QGroupBox(HollowPoly_Dialog)
...
"")
        ...
        self.formLayout.setWidget(1, QFormLayout.FieldRole, self.tw_inputlineEdit)
...
"")
        ...
        self.formLayout.setWidget(2, QFormLayout.FieldRole, self.SidesNum_lineEdit)
        ...
        self.HollowPoly_groupBox = QGroupBox(HollowPoly_Dialog)
        self.HollowPoly_groupBox.setObjectName(u"HollowPoly_groupBox")
        self.HollowPoly_groupBox.setMinimumSize(QSize(0, 80))
        self.HollowPoly_groupBox.setStyleSheet(u"color: rgb(255, 255, 255);\n"
"background-color: rgb(128, 128, 128);")
        self.gridLayout_2 = QGridLayout(self.HollowPoly_groupBox)
...
"")
        ...
        self.fy_inputlineEdit = QLineEdit(self.HollowPoly_groupBox)
...
"")
        ...
        self.eu_label = QLabel(self.HollowPoly_groupBox)
        self.eu_label.setObjectName(u"eu_label")

        self.gridLayout.addWidget(self.eu_label, 1, 4, 1, 1)

        self.G_inputlineEdit = QLineEdit(self.HollowPoly_groupBox)
...
"")
        ...
        self.E_inputlineEdit = QLineEdit(self.HollowPoly_groupBox)
...
"")
        ...
        self.ID_inputlineEdit = QLineEdit(self.HollowPoly_groupBox)
...
"")
        ...
        self.ColorButton = QPushButton(self.HollowPoly_groupBox)
...
"")
        ...
        self.gridLayout_3.addWidget(self.HollowPoly_groupBox, 0, 0, 1, 1)

        self.button_GroupBox = QGroupBox(HollowPoly_Dialog)
...
"")
        ...
        QWidget.setTabOrder(self.B_inputlineEdit, self.tw_inputlineEdit)
        QWidget.setTabOrder(self.tw_inputlineEdit, self.SidesNum_lineEdit)
        QWidget.setTabOrder(self.SidesNum_lineEdit, self.Import_pushButton)
        ...
        self.retranslateUi(HollowPoly_Dialog)

        QMetaObject.connectSlotsByName(HollowPoly_Dialog)
    # setupUi

    def retranslateUi(self, HollowPoly_Dialog):
        HollowPoly_Dialog.setWindowTitle(QCoreApplication.translate("HollowPoly_Dialog", u"Hollow Polygon - Template", None))
        self.label.setText("")
        self.ModelingType_groupBox.setTitle(QCoreApplication.translate("HollowPoly_Dialog", u"Modeling Type", None))
        self.Centerline_radioButton.setText(QCoreApplication.translate("HollowPoly_Dialog", u"Centerline", None))
        self.Outline_radioButton.setText(QCoreApplication.translate("HollowPoly_Dialog", u"Outline", None))
        self.Dimension_groupBox.setTitle(QCoreApplication.translate("HollowPoly_Dialog", u"Dimension", None))
        self.B_label.setText(QCoreApplication.translate("HollowPoly_Dialog", u"B = ", None))
        self.tw_label.setText(QCoreApplication.translate("HollowPoly_Dialog", u"tw = ", None))
        self.label_2.setText(QCoreApplication.translate("HollowPoly_Dialog", u"Sides Num = ", None))
        self.HollowPoly_groupBox.setTitle(QCoreApplication.translate("HollowPoly_Dialog", u"Material", None))
        self.G_label.setText(QCoreApplication.translate("HollowPoly_Dialog", u" E  = ", None))
        self.ID_label.setText(QCoreApplication.translate("HollowPoly_Dialog", u"Color = ", None))
        self.E_label.setText(QCoreApplication.translate("HollowPoly_Dialog", u"ID = ", None))
        self.fy_label.setText(QCoreApplication.translate("HollowPoly_Dialog", u"fy  = ", None))
        self.Color_label.setText(QCoreApplication.translate("HollowPoly_Dialog", u"     \u03bc   = ", None))
        self.eu_label.setText(QCoreApplication.translate("HollowPoly_Dialog", u"eu = ", None))
        self.ColorButton.setText("")
        self.Import_pushButton.setText(QCoreApplication.translate("HollowPoly_Dialog", u"Import", None))
        self.OK_button.setText(QCoreApplication.translate("HollowPoly_Dialog", u"OK", None))
        self.Cancel_pushButton.setText(QCoreApplication.translate("HollowPoly_Dialog", u"Cancel", None))
    # retranslateUi
