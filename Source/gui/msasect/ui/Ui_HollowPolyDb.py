# Form implementation generated from reading ui file 'HollowPolyDb.ui'
#
...
class Ui_HollowPolyDb_Dialog(object):
    def setupUi(self, HollowPolyDb_Dialog):
        HollowPolyDb_Dialog.setObjectName("HollowPolyDb_Dialog")
        HollowPolyDb_Dialog.resize(447, 561)
        HollowPolyDb_Dialog.setStyleSheet("*{    \n"
"    color: rgb(255, 255, 255);\n"
"    font: 9pt \"Segoe UI\";\n"
"    background-color: rgb(43, 43, 43);\n"
"}\n"
"")
        self.verticalLayout = QtWidgets.QVBoxLayout(HollowPolyDb_Dialog)
        ...
        self.CSection_groupBox = QtWidgets.QGroupBox(HollowPolyDb_Dialog)
...
"}")
        ...
        self.label = QtWidgets.QLabel(self.CSection_groupBox)
...
"")
        ...
        self.groupBox = QtWidgets.QGroupBox(HollowPolyDb_Dialog)
...
"}")
        ...
        self.OK_button.setStyleSheet("QPushButton::hover{background-color:rgb(144, 200, 246)}\n"
...
"}")
        ...
        self.Cancel_pushButton.setStyleSheet("QPushButton::hover{background-color:rgb(144, 200, 246)}\n"
"QPushButton::disabled{color:rgb(153, 153, 153)}\n"
"QPushButton{    \n"
"    font: 9pt \"Segoe UI\";\n"
"    color: rgb(0, 0, 0);\n"
...
"}")
        ...
        self.retranslateUi(HollowPolyDb_Dialog)
        QtCore.QMetaObject.connectSlotsByName(HollowPolyDb_Dialog)

    def retranslateUi(self, HollowPolyDb_Dialog):
        _translate = QtCore.QCoreApplication.translate
        HollowPolyDb_Dialog.setWindowTitle(_translate("HollowPolyDb_Dialog", "Hollow Polygon - Database"))
        self.CSection_groupBox.setTitle(_translate("HollowPolyDb_Dialog", "Database"))
        self.ComboBox.setItemText(0, _translate("HollowPolyDb_Dialog", "User-Polygon(mm)"))
        self.ComboBox.setItemText(1, _translate("HollowPolyDb_Dialog", "User-Polygon(in)"))
        self.groupBox_3.setTitle(_translate("HollowPolyDb_Dialog", "Section name:"))
        self.groupBox_2.setTitle(_translate("HollowPolyDb_Dialog", "Dimensions:"))
        self.OK_button.setText(_translate("HollowPolyDb_Dialog", "OK"))
        self.Cancel_pushButton.setText(_translate("HollowPolyDb_Dialog", "Cancel"))
