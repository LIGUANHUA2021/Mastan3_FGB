...
from gui.msasect.ui.Ui_ZSectionDb import Ui_ZSectionDb_Dialog
...
class ZSectionDb_Dialog(QDialog, Ui_ZSectionDb_Dialog):
    """
    ...
    def on_OK_button_clicked(self):
        ...
        if self.ComboBox.currentText()=="User-Z(in)":
            unit=0
        else:
            unit = 1
    ...
    def initlize(self):
        self.label.setPixmap(QPixmap("ui/Template/Z-Section_Db.jpg"))
        Database = self.ComboBox.currentText()
        if Database == "User-Z(in)":
