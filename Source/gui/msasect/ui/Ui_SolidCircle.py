...
################################################################################
## Form generated from reading UI file 'SolidCircle.ui'
##
...
class Ui_SolidCircle_Dialog(object):
    def setupUi(self, SolidCircle_Dialog):
        if not SolidCircle_Dialog.objectName():
            SolidCircle_Dialog.setObjectName(u"SolidCircle_Dialog")
        SolidCircle_Dialog.resize(540, 533)
        SolidCircle_Dialog.setMinimumSize(QSize(540, 529))
        SolidCircle_Dialog.setMaximumSize(QSize(540, 533))
        SolidCircle_Dialog.setStyleSheet(u"*{	\n"
"	color: rgb(255, 255, 255);\n"
"	font: 9pt \"Segoe UI\";\n"
"	background-color: rgb(43, 43, 43);\n"
"}\n"
"")
        self.gridLayout_3 = QGridLayout(SolidCircle_Dialog)
        ...
        self.label = QLabel(SolidCircle_Dialog)
        ...
        self.ModelingType_groupBox = QGroupBox(SolidCircle_Dialog)
        ...
        self.Dimension_groupBox = QGroupBox(SolidCircle_Dialog)
...
"")
        ...
        self.SolidCircle_groupBox = QGroupBox(SolidCircle_Dialog)
        self.SolidCircle_groupBox.setObjectName(u"SolidCircle_groupBox")
        self.SolidCircle_groupBox.setMinimumSize(QSize(0, 80))
        self.SolidCircle_groupBox.setStyleSheet(u"color: rgb(255, 255, 255);\n"
"background-color: rgb(128, 128, 128);")
        self.gridLayout_2 = QGridLayout(self.SolidCircle_groupBox)
...
"")
        ...
        self.fy_inputlineEdit = QLineEdit(self.SolidCircle_groupBox)
...
"")
        ...
        self.eu_label = QLabel(self.SolidCircle_groupBox)
        self.eu_label.setObjectName(u"eu_label")

        self.gridLayout.addWidget(self.eu_label, 1, 4, 1, 1)

        self.G_inputlineEdit = QLineEdit(self.SolidCircle_groupBox)
...
"")
        ...
        self.E_inputlineEdit = QLineEdit(self.SolidCircle_groupBox)
...
"")
        ...
        self.ID_inputlineEdit = QLineEdit(self.SolidCircle_groupBox)
...
"")
        ...
        self.ColorButton = QPushButton(self.SolidCircle_groupBox)
...
"")
        ...
        self.button_GroupBox = QGroupBox(SolidCircle_Dialog)
...
"")
        ...
        QMetaObject.connectSlotsByName(SolidCircle_Dialog)
    # setupUi

    def retranslateUi(self, SolidCircle_Dialog):
        SolidCircle_Dialog.setWindowTitle(QCoreApplication.translate("SolidCircle_Dialog", u"Solid Circle - Template", None))
        self.label.setText("")
        self.ModelingType_groupBox.setTitle(QCoreApplication.translate("SolidCircle_Dialog", u"Modeling Type", None))
        self.Centerline_radioButton.setText(QCoreApplication.translate("SolidCircle_Dialog", u"Centerline", None))
        self.Outline_radioButton.setText(QCoreApplication.translate("SolidCircle_Dialog", u"Outline", None))
        self.Dimension_groupBox.setTitle(QCoreApplication.translate("SolidCircle_Dialog", u"Dimension", None))
        self.B_label.setText(QCoreApplication.translate("SolidCircle_Dialog", u"B = ", None))
        self.tw_label.setText(QCoreApplication.translate("SolidCircle_Dialog", u"D = ", None))
        self.SolidCircle_groupBox.setTitle(QCoreApplication.translate("SolidCircle_Dialog", u"Material", None))
        self.G_label.setText(QCoreApplication.translate("SolidCircle_Dialog", u" E  = ", None))
        self.ID_label.setText(QCoreApplication.translate("SolidCircle_Dialog", u"Color = ", None))
        self.E_label.setText(QCoreApplication.translate("SolidCircle_Dialog", u"ID = ", None))
        self.fy_label.setText(QCoreApplication.translate("SolidCircle_Dialog", u"fy  = ", None))
        self.Color_label.setText(QCoreApplication.translate("SolidCircle_Dialog", u"     \u03bc   = ", None))
        self.eu_label.setText(QCoreApplication.translate("SolidCircle_Dialog", u"eu = ", None))
        self.ColorButton.setText("")
        self.OK_button.setText(QCoreApplication.translate("SolidCircle_Dialog", u"OK", None))
        self.Cancel_pushButton.setText(QCoreApplication.translate("SolidCircle_Dialog", u"Cancel", None))
    # retranslateUi
