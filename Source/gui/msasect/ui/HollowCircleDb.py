...
from gui.msasect.ui.Ui_HollowCircleDb import Ui_HollowCircleDb_Dialog


class library_Path:
    Path = r"base/library/"
    SectType = r"AISC-RoundHSS"


class HollowCircleDb_Dialog(QDialog, Ui_HollowCircleDb_Dialog):
    """
    ...
    def initlize(self):
        self.label.setPixmap(QPixmap("ui/Template/Hollow Circle_Db.jpg"))
