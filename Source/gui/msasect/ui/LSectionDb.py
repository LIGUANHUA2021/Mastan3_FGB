...
from gui.msasect.ui.Ui_LSectionDb import Ui_LSectionDb_Dialog
...
class LSectionDb_Dialog(QDialog, Ui_LSectionDb_Dialog):
    """
    ...
    def initlize(self):
        self.label.setPixmap(QPixmap("ui/Template/L-Section_Db.jpg"))
