...
from gui.msasect.ui.Ui_HollowRecDb import Ui_HollowRecDb_Dialog

class library_Path:
    Path = r"base/library/"
    SectType = r"AISC-RecHSS"


class HollowRecDb_Dialog(QDialog, Ui_HollowRecDb_Dialog):
    """
    ...
    def initlize(self):
        self.label.setPixmap(QPixmap("ui/Template/Hollow Rec_Db.jpg"))
