...
################################################################################
## Form generated from reading UI file 'CSection.ui'
##
...
class Ui_CSection_Dialog(object):
    def setupUi(self, CSection_Dialog):
        if not CSection_Dialog.objectName():
            CSection_Dialog.setObjectName(u"CSection_Dialog")
        CSection_Dialog.resize(540, 533)
        CSection_Dialog.setMinimumSize(QSize(540, 533))
        CSection_Dialog.setMaximumSize(QSize(540, 533))
        CSection_Dialog.setStyleSheet(u"*{	\n"
"	color: rgb(255, 255, 255);\n"
"	font: 9pt \"Segoe UI\";\n"
"	background-color: rgb(43, 43, 43);\n"
"}\n"
"")
        self.gridLayout_3 = QGridLayout(CSection_Dialog)
        ...
        self.label = QLabel(CSection_Dialog)
        ...
        self.ModelingType_groupBox = QGroupBox(CSection_Dialog)
        ...
        self.Dimension_groupBox = QGroupBox(CSection_Dialog)
...
"")
        ...
        self.tf_inputlineEdit = QLineEdit(self.Dimension_groupBox)
        self.tf_inputlineEdit.setObjectName(u"tf_inputlineEdit")
        self.tf_inputlineEdit.setStyleSheet(u"*{	\n"
"	font: 9pt \"Segoe UI\";\n"
"	color: rgb(0, 0, 0);\n"
"	background: rgb(255, 255, 255);\n"
"}\n"
"")
        ...
        self.formLayout.setWidget(2, QFormLayout.FieldRole, self.tf_inputlineEdit)
...
"")
        ...
        self.formLayout.setWidget(3, QFormLayout.FieldRole, self.tw_inputlineEdit)
...
"")
        ...
        self.formLayout.setWidget(4, QFormLayout.FieldRole, self.k_inputlineEdit)
        ...
        self.theta_inputlineEdit = QLineEdit(self.Dimension_groupBox)
        self.theta_inputlineEdit.setObjectName(u"theta_inputlineEdit")
        self.theta_inputlineEdit.setStyleSheet(u"*{	\n"
"	font: 9pt \"Segoe UI\";\n"
"	color: rgb(0, 0, 0);\n"
"	background: rgb(255, 255, 255);\n"
"}\n"
"")
        ...
        self.formLayout.setWidget(6, QFormLayout.FieldRole, self.theta_inputlineEdit)
        ...
        self.formLayout.setItem(7, QFormLayout.FieldRole, self.verticalSpacer_2)

        self.k1_label = QLabel(self.Dimension_groupBox)
        self.k1_label.setObjectName(u"k1_label")

        self.formLayout.setWidget(5, QFormLayout.LabelRole, self.k1_label)

        self.k1_lineEdit = QLineEdit(self.Dimension_groupBox)
        self.k1_lineEdit.setObjectName(u"k1_lineEdit")
        self.k1_lineEdit.setStyleSheet(u"*{	\n"
"	font: 9pt \"Segoe UI\";\n"
"	color: rgb(0, 0, 0);\n"
"	background: rgb(255, 255, 255);\n"
"}\n"
"")
        ...
        self.formLayout.setWidget(5, QFormLayout.FieldRole, self.k1_lineEdit)
        ...
        self.CSection_groupBox = QGroupBox(CSection_Dialog)
        self.CSection_groupBox.setObjectName(u"CSection_groupBox")
        self.CSection_groupBox.setMinimumSize(QSize(0, 80))
        self.CSection_groupBox.setStyleSheet(u"color: rgb(255, 255, 255);\n"
"background-color: rgb(128, 128, 128);")
        self.gridLayout_2 = QGridLayout(self.CSection_groupBox)
...
"")
        ...
        self.fy_inputlineEdit = QLineEdit(self.CSection_groupBox)
...
"")
        ...
        self.eu_label = QLabel(self.CSection_groupBox)
        self.eu_label.setObjectName(u"eu_label")

        self.gridLayout.addWidget(self.eu_label, 1, 4, 1, 1)

        self.G_inputlineEdit = QLineEdit(self.CSection_groupBox)
...
"")
        ...
        self.E_inputlineEdit = QLineEdit(self.CSection_groupBox)
...
"")
        ...
        self.ID_inputlineEdit = QLineEdit(self.CSection_groupBox)
...
"")
        ...
        self.ColorButton = QPushButton(self.CSection_groupBox)
...
"")
        ...
        self.gridLayout_3.addWidget(self.CSection_groupBox, 0, 0, 1, 1)

        self.button_GroupBox = QGroupBox(CSection_Dialog)
        ...
        self.Import_pushButton.setStyleSheet(u"QPushButton::hover{background-color:rgb(144, 200, 246)}\n"
...
"}")
        ...
        QWidget.setTabOrder(self.D_inputlineEdit, self.tf_inputlineEdit)
        QWidget.setTabOrder(self.tf_inputlineEdit, self.tw_inputlineEdit)
        QWidget.setTabOrder(self.tw_inputlineEdit, self.k_inputlineEdit)
        QWidget.setTabOrder(self.k_inputlineEdit, self.k1_lineEdit)
        QWidget.setTabOrder(self.k1_lineEdit, self.theta_inputlineEdit)
        QWidget.setTabOrder(self.theta_inputlineEdit, self.ColorButton)
        ...
        self.retranslateUi(CSection_Dialog)

        QMetaObject.connectSlotsByName(CSection_Dialog)
    # setupUi

    def retranslateUi(self, CSection_Dialog):
        CSection_Dialog.setWindowTitle(QCoreApplication.translate("CSection_Dialog", u"C-Section - Template", None))
        self.label.setText("")
        self.ModelingType_groupBox.setTitle(QCoreApplication.translate("CSection_Dialog", u"Modeling Type", None))
        self.Centerline_radioButton.setText(QCoreApplication.translate("CSection_Dialog", u"Centerline", None))
        self.Outline_radioButton.setText(QCoreApplication.translate("CSection_Dialog", u"Outline", None))
        self.Dimension_groupBox.setTitle(QCoreApplication.translate("CSection_Dialog", u"Dimension", None))
        self.B_label.setText(QCoreApplication.translate("CSection_Dialog", u"B = ", None))
        self.D_label.setText(QCoreApplication.translate("CSection_Dialog", u"D = ", None))
        self.tf_label.setText(QCoreApplication.translate("CSection_Dialog", u"tf = ", None))
        self.tw_label.setText(QCoreApplication.translate("CSection_Dialog", u"tw = ", None))
        self.label_2.setText(QCoreApplication.translate("CSection_Dialog", u"k =", None))
        self.k_inputlineEdit.setText("")
        self.label_3.setText(QCoreApplication.translate("CSection_Dialog", u"ks = ", None))
        self.k1_label.setText(QCoreApplication.translate("CSection_Dialog", u"k1 = ", None))
        self.CSection_groupBox.setTitle(QCoreApplication.translate("CSection_Dialog", u"Material", None))
        self.G_label.setText(QCoreApplication.translate("CSection_Dialog", u"E   = ", None))
        self.ID_label.setText(QCoreApplication.translate("CSection_Dialog", u"Color = ", None))
        self.E_label.setText(QCoreApplication.translate("CSection_Dialog", u"ID = ", None))
        self.fy_label.setText(QCoreApplication.translate("CSection_Dialog", u"fy  = ", None))
        self.Color_label.setText(QCoreApplication.translate("CSection_Dialog", u"     \u03bc   = ", None))
        self.eu_label.setText(QCoreApplication.translate("CSection_Dialog", u"eu = ", None))
        self.ColorButton.setText("")
        self.Import_pushButton.setText(QCoreApplication.translate("CSection_Dialog", u"Import", None))
        self.OK_button.setText(QCoreApplication.translate("CSection_Dialog", u"OK", None))
        self.Cancel_pushButton.setText(QCoreApplication.translate("CSection_Dialog", u"Cancel", None))
    # retranslateUi
