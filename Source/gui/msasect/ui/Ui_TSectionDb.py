# Form implementation generated from reading ui file 'TSectionDb.ui'
#
...
class Ui_TSectionDb_Dialog(object):
    def setupUi(self, TSectionDb_Dialog):
        TSectionDb_Dialog.setObjectName("TSectionDb_Dialog")
        TSectionDb_Dialog.resize(447, 561)
        TSectionDb_Dialog.setStyleSheet("*{    \n"
"    color: rgb(255, 255, 255);\n"
"    font: 9pt \"Segoe UI\";\n"
"    background-color: rgb(43, 43, 43);\n"
"}\n"
"")
        self.verticalLayout = QtWidgets.QVBoxLayout(TSectionDb_Dialog)
        ...
        self.TSectionDb_groupBox = QtWidgets.QGroupBox(TSectionDb_Dialog)
        self.TSectionDb_groupBox.setStyleSheet("color: rgb(255, 255, 255);\n"
"background-color: rgb(128, 128, 128);")
        self.TSectionDb_groupBox.setObjectName("TSectionDb_groupBox")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.TSectionDb_groupBox)
        ...
        self.ComboBox = QtWidgets.QComboBox(self.TSectionDb_groupBox)
...
"}")
        ...
        self.groupBox_3 = QtWidgets.QGroupBox(self.TSectionDb_groupBox)
        ...
        self.label = QtWidgets.QLabel(self.TSectionDb_groupBox)
...
"")
        ...
        self.groupBox_2 = QtWidgets.QGroupBox(self.TSectionDb_groupBox)
        ...
        self.verticalLayout.addWidget(self.TSectionDb_groupBox)
        ...
        self.groupBox = QtWidgets.QGroupBox(TSectionDb_Dialog)
...
"}")
        ...
        self.retranslateUi(TSectionDb_Dialog)
        QtCore.QMetaObject.connectSlotsByName(TSectionDb_Dialog)

    def retranslateUi(self, TSectionDb_Dialog):
        _translate = QtCore.QCoreApplication.translate
        TSectionDb_Dialog.setWindowTitle(_translate("TSectionDb_Dialog", "T-Section - Database"))
        self.TSectionDb_groupBox.setTitle(_translate("TSectionDb_Dialog", "Database"))
        self.ComboBox.setItemText(0, _translate("TSectionDb_Dialog", "AISC(mm)"))
        self.ComboBox.setItemText(1, _translate("TSectionDb_Dialog", "AISC(in)"))
        self.groupBox_3.setTitle(_translate("TSectionDb_Dialog", "Section name:"))
        self.groupBox_2.setTitle(_translate("TSectionDb_Dialog", "Dimensions:"))
        self.OK_button.setText(_translate("TSectionDb_Dialog", "OK"))
        self.Cancel_pushButton.setText(_translate("TSectionDb_Dialog", "Cancel"))
