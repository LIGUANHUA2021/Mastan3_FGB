# Form implementation generated from reading ui file 'ZSectionDb.ui'
#
...
class Ui_ZSectionDb_Dialog(object):
    def setupUi(self, ZSectionDb_Dialog):
        ZSectionDb_Dialog.setObjectName("ZSectionDb_Dialog")
        ZSectionDb_Dialog.resize(447, 561)
        ZSectionDb_Dialog.setStyleSheet("*{    \n"
"    color: rgb(255, 255, 255);\n"
"    font: 9pt \"Segoe UI\";\n"
"    background-color: rgb(43, 43, 43);\n"
"}\n"
"")
        self.verticalLayout = QtWidgets.QVBoxLayout(ZSectionDb_Dialog)
        ...
        self.ZSectionDb_groupBox = QtWidgets.QGroupBox(ZSectionDb_Dialog)
        self.ZSectionDb_groupBox.setStyleSheet("color: rgb(255, 255, 255);\n"
"background-color: rgb(128, 128, 128);")
        self.ZSectionDb_groupBox.setObjectName("ZSectionDb_groupBox")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.ZSectionDb_groupBox)
        ...
        self.ComboBox = QtWidgets.QComboBox(self.ZSectionDb_groupBox)
...
"}")
        ...
        self.groupBox_3 = QtWidgets.QGroupBox(self.ZSectionDb_groupBox)
        ...
        self.label = QtWidgets.QLabel(self.ZSectionDb_groupBox)
...
"")
        ...
        self.groupBox_2 = QtWidgets.QGroupBox(self.ZSectionDb_groupBox)
        ...
        self.verticalLayout.addWidget(self.ZSectionDb_groupBox)
        ...
        self.groupBox = QtWidgets.QGroupBox(ZSectionDb_Dialog)
...
"}")
        ...
        self.retranslateUi(ZSectionDb_Dialog)
        QtCore.QMetaObject.connectSlotsByName(ZSectionDb_Dialog)

    def retranslateUi(self, ZSectionDb_Dialog):
        _translate = QtCore.QCoreApplication.translate
        ZSectionDb_Dialog.setWindowTitle(_translate("ZSectionDb_Dialog", "Z-Section - Database"))
        self.ZSectionDb_groupBox.setTitle(_translate("ZSectionDb_Dialog", "Database"))
        self.ComboBox.setItemText(0, _translate("ZSectionDb_Dialog", "User-Z(mm)"))
        self.ComboBox.setItemText(1, _translate("ZSectionDb_Dialog", "User-Z(in)"))
        self.groupBox_3.setTitle(_translate("ZSectionDb_Dialog", "Section name:"))
        self.groupBox_2.setTitle(_translate("ZSectionDb_Dialog", "Dimensions:"))
        self.OK_button.setText(_translate("ZSectionDb_Dialog", "OK"))
        self.Cancel_pushButton.setText(_translate("ZSectionDb_Dialog", "Cancel"))
