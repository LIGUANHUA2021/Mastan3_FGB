...
################################################################################
## Form generated from reading UI file 'MCAnalMessageBox.ui'
##
...
class Ui_MCAnalMessageBox_Dialog(object):
    def setupUi(self, MCAnalMessageBox_Dialog):
        if not MCAnalMessageBox_Dialog.objectName():
            MCAnalMessageBox_Dialog.setObjectName(u"MCAnalMessageBox_Dialog")
        MCAnalMessageBox_Dialog.resize(621, 548)
        MCAnalMessageBox_Dialog.setStyleSheet(u"QDialog\n"
"{\n"
...
"	padding: 0;\n"
"}")
        MCAnalMessageBox_Dialog.setSizeGripEnabled(False)
        self.gridLayout = QGridLayout(MCAnalMessageBox_Dialog)
        self.gridLayout.setSpacing(2)
        self.gridLayout.setObjectName(u"gridLayout")
        self.gridLayout.setSizeConstraint(QLayout.SetDefaultConstraint)
        self.gridLayout.setContentsMargins(2, 2, 2, 2)
        self.MCMessageBox_textBrowser = CustomTextBrowser(MCAnalMessageBox_Dialog)
        self.MCMessageBox_textBrowser.setObjectName(u"MCMessageBox_textBrowser")
        font = QFont()
        ...
        self.groupBox_4 = QGroupBox(MCAnalMessageBox_Dialog)
...
"}")
        ...
        self.groupBox = QGroupBox(MCAnalMessageBox_Dialog)
        ...
        self.retranslateUi(MCAnalMessageBox_Dialog)

        QMetaObject.connectSlotsByName(MCAnalMessageBox_Dialog)
    # setupUi

    def retranslateUi(self, MCAnalMessageBox_Dialog):
        MCAnalMessageBox_Dialog.setWindowTitle(QCoreApplication.translate("MCAnalMessageBox_Dialog", u"Analysis is running, please wait patiently ...", None))
        self.groupBox_4.setTitle("")
        self.STime_label.setText(QCoreApplication.translate("MCAnalMessageBox_Dialog", u"Start Time\uff1a", None))
        self.StartTimeDay_label.setText("")
        self.StartTimer_label.setText("")
        self.Stop_pushButton.setText(QCoreApplication.translate("MCAnalMessageBox_Dialog", u"Stop", None))
        self.OK_pushButton.setText(QCoreApplication.translate("MCAnalMessageBox_Dialog", u"OK", None))
        self.groupBox.setTitle("")
        self.ExportMessage_label.setText(QCoreApplication.translate("MCAnalMessageBox_Dialog", u"Export message to:", None))
        self.ExportFileFormat_comboBox.setItemText(0, QCoreApplication.translate("MCAnalMessageBox_Dialog", u"Text File Format", None))
