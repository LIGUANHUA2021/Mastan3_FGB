...
import numpy as np
from gui.msasect.ui.Ui_SolidPoly import Ui_SolidPoly_Dialog
...
class SolidPoly_Dialog(QDialog, Ui_SolidPoly_Dialog):
    """
    ...
    def __init__(self, mw, parent=None):
        ...
        self.setupUi(self)
        self.setWindowIcon(QIcon('ui/ico/TemplateIcon/Solid Poly.ico'))
        self.color = '#aaffff'
    ...
    def initDialog(self):
        self.label.setPixmap(QPixmap("ui/Template/Solid Poly.jpg"))
        ...
        self.B_inputlineEdit.setText(str(100))
        self.SidesNum_lineEdit.setText(str(6))
        # 设置validator
    ...
    def on_OK_button_clicked(self):
        ...
        try:
            if len(self.E_inputlineEdit.text()) == 0 or len(self.G_inputlineEdit.text()) == 0 or len(
                    self.fy_inputlineEdit.text()) == 0 or len(self.B_inputlineEdit.text()) == 0 or float(self.SidesNum_lineEdit.text())<3:
                ...
                if B<0 or SidesNum<3 or tE<0 or tμ<0 or tfy<0 or teu<0:
                    showMesbox(self, 'Please input correct data!')
                else:
                    ...
                    if id in MatIdDict:
                        ...
                        Status.Reset()
                        self.mw.SectIDInput_lineEdit.setText('SolidPoly01')
                        self.accept()
                        SectProperty.Reset()
