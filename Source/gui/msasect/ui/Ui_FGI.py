...
################################################################################
## Form generated from reading UI file 'FGI.ui'
##
...
class Ui_FGI_Dialog(object):
    def setupUi(self, FGI_Dialog):
        if not FGI_Dialog.objectName():
            FGI_Dialog.setObjectName(u"FGI_Dialog")
        FGI_Dialog.resize(540, 555)
        FGI_Dialog.setMinimumSize(QSize(540, 555))
        FGI_Dialog.setMaximumSize(QSize(540, 555))
        FGI_Dialog.setStyleSheet(u"*{	\n"
"	color: rgb(255, 255, 255);\n"
"	font: 9pt \"Segoe UI\";\n"
"	background-color: rgb(43, 43, 43);\n"
"}\n"
"")
        self.gridLayout_3 = QGridLayout(FGI_Dialog)
        ...
        self.ModelingType_groupBox = QGroupBox(FGI_Dialog)
        ...
        self.Dimension_groupBox = QGroupBox(FGI_Dialog)
...
"")
        ...
        self.formLayout.setWidget(2, QFormLayout.LabelRole, self.tw_label)
...
"")
        ...
        self.formLayout.setWidget(3, QFormLayout.FieldRole, self.tf_inputlineEdit)
...
"")
        ...
        self.formLayout.setWidget(4, QFormLayout.FieldRole, self.tw_inputlineEdit)
        ...
        self.FGI_groupBox = QGroupBox(FGI_Dialog)
        self.FGI_groupBox.setObjectName(u"FGI_groupBox")
        self.FGI_groupBox.setMinimumSize(QSize(0, 80))
        self.FGI_groupBox.setStyleSheet(u"color: rgb(255, 255, 255);\n"
"background-color: rgb(128, 128, 128);")
        self.gridLayout_2 = QGridLayout(self.FGI_groupBox)
        ...
        self.label_3 = QLabel(self.FGI_groupBox)
        self.label_3.setObjectName(u"label_3")

        self.gridLayout.addWidget(self.label_3, 0, 0, 1, 1)

        self.Color_label = QLabel(self.FGI_groupBox)
        self.Color_label.setObjectName(u"Color_label")

        self.gridLayout.addWidget(self.Color_label, 2, 0, 1, 1)

        self.Law_comboBox = QComboBox(self.FGI_groupBox)
...
"}")
        ...
        self.G_inputlineEdit = QLineEdit(self.FGI_groupBox)
...
"")
        ...
        self.eu_label = QLabel(self.FGI_groupBox)
        self.eu_label.setObjectName(u"eu_label")

        self.gridLayout.addWidget(self.eu_label, 0, 4, 1, 1)

        self.eu_inputlineEdit = QLineEdit(self.FGI_groupBox)
...
"")
        ...
        self.E_label = QLabel(self.FGI_groupBox)
        self.E_label.setObjectName(u"E_label")

        self.gridLayout.addWidget(self.E_label, 1, 0, 1, 1)

        self.Ei_inputlineEdit = QLineEdit(self.FGI_groupBox)
...
"")
        ...
        self.G_label = QLabel(self.FGI_groupBox)
        self.G_label.setObjectName(u"G_label")

        self.gridLayout.addWidget(self.G_label, 1, 2, 1, 1)

        self.E0_inputlineEdit = QLineEdit(self.FGI_groupBox)
...
"")
        ...
        self.fy_label = QLabel(self.FGI_groupBox)
        self.fy_label.setObjectName(u"fy_label")

        self.gridLayout.addWidget(self.fy_label, 1, 4, 1, 1)

        self.fy_inputlineEdit = QLineEdit(self.FGI_groupBox)
...
"")
        ...
        self.label_2 = QLabel(self.FGI_groupBox)
        self.label_2.setObjectName(u"label_2")

        self.gridLayout.addWidget(self.label_2, 0, 2, 1, 1)

        self.label_4 = QLabel(self.FGI_groupBox)
        self.label_4.setObjectName(u"label_4")

        self.gridLayout.addWidget(self.label_4, 2, 2, 1, 1)

        self.Num_inputlineEdit = QLineEdit(self.FGI_groupBox)
...
"")
        ...
        self.k_inputlineEdit = QLineEdit(self.FGI_groupBox)
...
"")
        ...
        self.gridLayout_3.addWidget(self.FGI_groupBox, 0, 0, 1, 1)

        self.button_GroupBox = QGroupBox(FGI_Dialog)
...
"")
        ...
        QWidget.setTabOrder(self.Law_comboBox, self.Num_inputlineEdit)
        QWidget.setTabOrder(self.Num_inputlineEdit, self.eu_inputlineEdit)
        QWidget.setTabOrder(self.eu_inputlineEdit, self.Ei_inputlineEdit)
        QWidget.setTabOrder(self.Ei_inputlineEdit, self.E0_inputlineEdit)
        QWidget.setTabOrder(self.E0_inputlineEdit, self.fy_inputlineEdit)
        QWidget.setTabOrder(self.fy_inputlineEdit, self.G_inputlineEdit)
        QWidget.setTabOrder(self.G_inputlineEdit, self.k_inputlineEdit)
        QWidget.setTabOrder(self.k_inputlineEdit, self.Centerline_radioButton)
        ...
        QWidget.setTabOrder(self.tw_inputlineEdit, self.OK_button)
        QWidget.setTabOrder(self.OK_button, self.Cancel_pushButton)

        self.retranslateUi(FGI_Dialog)

        QMetaObject.connectSlotsByName(FGI_Dialog)
    # setupUi

    def retranslateUi(self, FGI_Dialog):
        FGI_Dialog.setWindowTitle(QCoreApplication.translate("FGI_Dialog", u"Functionally Graded I-Section-Template", None))
        self.label.setText("")
        self.ModelingType_groupBox.setTitle(QCoreApplication.translate("FGI_Dialog", u"Modeling Type", None))
        self.Centerline_radioButton.setText(QCoreApplication.translate("FGI_Dialog", u"Centerline", None))
        self.Outline_radioButton.setText(QCoreApplication.translate("FGI_Dialog", u"Outline", None))
        self.Dimension_groupBox.setTitle(QCoreApplication.translate("FGI_Dialog", u"Dimension", None))
        self.B_label.setText(QCoreApplication.translate("FGI_Dialog", u"B1 = ", None))
        self.label_8.setText(QCoreApplication.translate("FGI_Dialog", u"B2 = ", None))
        self.tw_label.setText(QCoreApplication.translate("FGI_Dialog", u"D = ", None))
        self.label_5.setText(QCoreApplication.translate("FGI_Dialog", u"tf = ", None))
        self.label_6.setText(QCoreApplication.translate("FGI_Dialog", u"tw = ", None))
        self.FGI_groupBox.setTitle(QCoreApplication.translate("FGI_Dialog", u"Material", None))
        self.label_3.setText(QCoreApplication.translate("FGI_Dialog", u"Gradation :", None))
        self.Color_label.setText(QCoreApplication.translate("FGI_Dialog", u"     \u03bc   = ", None))
        self.Law_comboBox.setItemText(0, QCoreApplication.translate("FGI_Dialog", u"Power law", None))
        self.Law_comboBox.setItemText(1, QCoreApplication.translate("FGI_Dialog", u"Exponential law", None))
        self.Law_comboBox.setItemText(2, QCoreApplication.translate("FGI_Dialog", u"Sigmoid law", None))

        self.eu_label.setText(QCoreApplication.translate("FGI_Dialog", u" eu = ", None))
        self.E_label.setText(QCoreApplication.translate("FGI_Dialog", u"     Ei = ", None))
        self.G_label.setText(QCoreApplication.translate("FGI_Dialog", u"     E0 = ", None))
        self.fy_label.setText(QCoreApplication.translate("FGI_Dialog", u" fy  = ", None))
        self.label_2.setText(QCoreApplication.translate("FGI_Dialog", u"Strip Num =", None))
        self.label_4.setText(QCoreApplication.translate("FGI_Dialog", u"     k =", None))
        self.OK_button.setText(QCoreApplication.translate("FGI_Dialog", u"OK", None))
        self.Cancel_pushButton.setText(QCoreApplication.translate("FGI_Dialog", u"Cancel", None))
    # retranslateUi
