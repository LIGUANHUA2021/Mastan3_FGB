...
################################################################################
## Form generated from reading UI file 'TaperedI.ui'
##
...
class Ui_TaperedI_Dialog(object):
    def setupUi(self, TaperedI_Dialog):
        if not TaperedI_Dialog.objectName():
            TaperedI_Dialog.setObjectName(u"TaperedI_Dialog")
        TaperedI_Dialog.resize(540, 533)
        TaperedI_Dialog.setMinimumSize(QSize(540, 529))
        TaperedI_Dialog.setMaximumSize(QSize(540, 533))
        TaperedI_Dialog.setStyleSheet(u"*{	\n"
"	color: rgb(255, 255, 255);\n"
"	font: 9pt \"Segoe UI\";\n"
"	background-color: rgb(43, 43, 43);\n"
"}\n"
"")
        self.gridLayout_3 = QGridLayout(TaperedI_Dialog)
        ...
        self.label = QLabel(TaperedI_Dialog)
        ...
        self.ModelingType_groupBox = QGroupBox(TaperedI_Dialog)
        ...
        self.Dimension_groupBox = QGroupBox(TaperedI_Dialog)
...
"")
        ...
        self.D1_inputlineEdit = QLineEdit(self.Dimension_groupBox)
        self.D1_inputlineEdit.setObjectName(u"D1_inputlineEdit")
        self.D1_inputlineEdit.setStyleSheet(u"*{	\n"
"	font: 9pt \"Segoe UI\";\n"
"	color: rgb(0, 0, 0);\n"
"	background: rgb(255, 255, 255);\n"
"}\n"
"")
        ...
        self.formLayout.setWidget(4, QFormLayout.FieldRole, self.D1_inputlineEdit)
        ...
        self.D2_inputlineEdit = QLineEdit(self.Dimension_groupBox)
        self.D2_inputlineEdit.setObjectName(u"D2_inputlineEdit")
        self.D2_inputlineEdit.setStyleSheet(u"*{	\n"
"	font: 9pt \"Segoe UI\";\n"
"	color: rgb(0, 0, 0);\n"
"	background: rgb(255, 255, 255);\n"
"}\n"
"")
        ...
        self.formLayout.setWidget(5, QFormLayout.FieldRole, self.D2_inputlineEdit)
        ...
        self.D3_inputlineEdit = QLineEdit(self.Dimension_groupBox)
        self.D3_inputlineEdit.setObjectName(u"D3_inputlineEdit")
        self.D3_inputlineEdit.setStyleSheet(u"*{	\n"
"	font: 9pt \"Segoe UI\";\n"
"	color: rgb(0, 0, 0);\n"
"	background: rgb(255, 255, 255);\n"
"}\n"
"")
        ...
        self.formLayout.setWidget(6, QFormLayout.FieldRole, self.D3_inputlineEdit)
        ...
        self.D4_inputlineEdit = QLineEdit(self.Dimension_groupBox)
        self.D4_inputlineEdit.setObjectName(u"D4_inputlineEdit")
        self.D4_inputlineEdit.setStyleSheet(u"*{	\n"
"	font: 9pt \"Segoe UI\";\n"
"	color: rgb(0, 0, 0);\n"
"	background: rgb(255, 255, 255);\n"
"}\n"
"")
        ...
        self.formLayout.setWidget(7, QFormLayout.FieldRole, self.D4_inputlineEdit)
        ...
        self.TaperedI_groupBox = QGroupBox(TaperedI_Dialog)
        self.TaperedI_groupBox.setObjectName(u"TaperedI_groupBox")
        self.TaperedI_groupBox.setMinimumSize(QSize(0, 80))
        self.TaperedI_groupBox.setStyleSheet(u"color: rgb(255, 255, 255);\n"
"background-color: rgb(128, 128, 128);")
        self.gridLayout_2 = QGridLayout(self.TaperedI_groupBox)
...
"")
        ...
        self.fy_inputlineEdit = QLineEdit(self.TaperedI_groupBox)
...
"")
        ...
        self.eu_label = QLabel(self.TaperedI_groupBox)
        self.eu_label.setObjectName(u"eu_label")

        self.gridLayout.addWidget(self.eu_label, 1, 4, 1, 1)

        self.G_inputlineEdit = QLineEdit(self.TaperedI_groupBox)
...
"")
        ...
        self.E_inputlineEdit = QLineEdit(self.TaperedI_groupBox)
...
"")
        ...
        self.ID_inputlineEdit = QLineEdit(self.TaperedI_groupBox)
...
"")
        ...
        self.ColorButton = QPushButton(self.TaperedI_groupBox)
...
"")
        ...
        self.gridLayout_3.addWidget(self.TaperedI_groupBox, 0, 0, 1, 1)

        self.button_GroupBox = QGroupBox(TaperedI_Dialog)
...
"")
        ...
        QWidget.setTabOrder(self.D_inputlineEdit, self.D1_inputlineEdit)
        QWidget.setTabOrder(self.D1_inputlineEdit, self.D2_inputlineEdit)
        QWidget.setTabOrder(self.D2_inputlineEdit, self.D3_inputlineEdit)
        QWidget.setTabOrder(self.D3_inputlineEdit, self.D4_inputlineEdit)
        QWidget.setTabOrder(self.D4_inputlineEdit, self.ColorButton)
        QWidget.setTabOrder(self.ColorButton, self.OK_button)
        QWidget.setTabOrder(self.OK_button, self.Cancel_pushButton)

        self.retranslateUi(TaperedI_Dialog)

        QMetaObject.connectSlotsByName(TaperedI_Dialog)
    # setupUi

    def retranslateUi(self, TaperedI_Dialog):
        TaperedI_Dialog.setWindowTitle(QCoreApplication.translate("TaperedI_Dialog", u"Tapered I - Template", None))
        self.label.setText("")
        self.ModelingType_groupBox.setTitle(QCoreApplication.translate("TaperedI_Dialog", u"Modeling Type", None))
        self.Centerline_radioButton.setText(QCoreApplication.translate("TaperedI_Dialog", u"Centerline", None))
        self.Outline_radioButton.setText(QCoreApplication.translate("TaperedI_Dialog", u"Outline", None))
        self.Dimension_groupBox.setTitle(QCoreApplication.translate("TaperedI_Dialog", u"Dimension", None))
        self.B_label.setText(QCoreApplication.translate("TaperedI_Dialog", u"B1 = ", None))
        self.tw_label.setText(QCoreApplication.translate("TaperedI_Dialog", u"B2 = ", None))
        self.label_2.setText(QCoreApplication.translate("TaperedI_Dialog", u"B3 = ", None))
        self.label_5.setText(QCoreApplication.translate("TaperedI_Dialog", u"D = ", None))
        self.label_6.setText(QCoreApplication.translate("TaperedI_Dialog", u"D1 = ", None))
        self.label_7.setText(QCoreApplication.translate("TaperedI_Dialog", u"D2 = ", None))
        self.label_8.setText(QCoreApplication.translate("TaperedI_Dialog", u"D3 = ", None))
        self.label_9.setText(QCoreApplication.translate("TaperedI_Dialog", u"D4 = ", None))
        self.TaperedI_groupBox.setTitle(QCoreApplication.translate("TaperedI_Dialog", u"Material", None))
        self.G_label.setText(QCoreApplication.translate("TaperedI_Dialog", u" E  = ", None))
        self.ID_label.setText(QCoreApplication.translate("TaperedI_Dialog", u"Color = ", None))
        self.E_label.setText(QCoreApplication.translate("TaperedI_Dialog", u"ID = ", None))
        self.fy_label.setText(QCoreApplication.translate("TaperedI_Dialog", u"fy  = ", None))
        self.Color_label.setText(QCoreApplication.translate("TaperedI_Dialog", u"     \u03bc   = ", None))
        self.eu_label.setText(QCoreApplication.translate("TaperedI_Dialog", u"eu = ", None))
        self.ColorButton.setText("")
        self.OK_button.setText(QCoreApplication.translate("TaperedI_Dialog", u"OK", None))
        self.Cancel_pushButton.setText(QCoreApplication.translate("TaperedI_Dialog", u"Cancel", None))
    # retranslateUi
