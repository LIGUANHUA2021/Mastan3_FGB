# Form implementation generated from reading ui file 'ISectionDb.ui'
#
...
class Ui_ISectionDb_Dialog(object):
    def setupUi(self, ISectionDb_Dialog):
        ISectionDb_Dialog.setObjectName("ISectionDb_Dialog")
        ISectionDb_Dialog.resize(447, 549)
        ISectionDb_Dialog.setStyleSheet("*{    \n"
"    color: rgb(255, 255, 255);\n"
"    font: 9pt \"Segoe UI\";\n"
"    background-color: rgb(43, 43, 43);\n"
"}\n"
"")
        self.verticalLayout = QtWidgets.QVBoxLayout(ISectionDb_Dialog)
        ...
        self.ISectionDb_groupBox = QtWidgets.QGroupBox(ISectionDb_Dialog)
        self.ISectionDb_groupBox.setStyleSheet("color: rgb(255, 255, 255);\n"
"background-color: rgb(128, 128, 128);")
        self.ISectionDb_groupBox.setObjectName("ISectionDb_groupBox")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.ISectionDb_groupBox)
        ...
        self.ComboBox = QtWidgets.QComboBox(self.ISectionDb_groupBox)
...
"}")
        ...
        self.groupBox_3 = QtWidgets.QGroupBox(self.ISectionDb_groupBox)
        ...
        self.label = QtWidgets.QLabel(self.ISectionDb_groupBox)
...
"")
        ...
        self.groupBox_2 = QtWidgets.QGroupBox(self.ISectionDb_groupBox)
        ...
        self.verticalLayout.addWidget(self.ISectionDb_groupBox)
        ...
        self.groupBox = QtWidgets.QGroupBox(ISectionDb_Dialog)
        self.groupBox.setMinimumSize(QtCore.QSize(0, 22))
...
"}")
        ...
        self.retranslateUi(ISectionDb_Dialog)
        QtCore.QMetaObject.connectSlotsByName(ISectionDb_Dialog)

    def retranslateUi(self, ISectionDb_Dialog):
        _translate = QtCore.QCoreApplication.translate
        ISectionDb_Dialog.setWindowTitle(_translate("ISectionDb_Dialog", "I-Section - Database"))
        self.ISectionDb_groupBox.setTitle(_translate("ISectionDb_Dialog", "Database"))
        self.ComboBox.setItemText(0, _translate("ISectionDb_Dialog", "AISC(mm)"))
        self.ComboBox.setItemText(1, _translate("ISectionDb_Dialog", "AISC(in)"))
        self.groupBox_3.setTitle(_translate("ISectionDb_Dialog", "Section name:"))
        self.groupBox_2.setTitle(_translate("ISectionDb_Dialog", "Dimensions:"))
        self.OK_button.setText(_translate("ISectionDb_Dialog", "OK"))
        self.Cancel_pushButton.setText(_translate("ISectionDb_Dialog", "Cancel"))
