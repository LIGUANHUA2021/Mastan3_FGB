...
################################################################################
## Form generated from reading UI file 'HollowTri.ui'
##
...
class Ui_HollowTri_Dialog(object):
    def setupUi(self, HollowTri_Dialog):
        if not HollowTri_Dialog.objectName():
            HollowTri_Dialog.setObjectName(u"HollowTri_Dialog")
        HollowTri_Dialog.resize(540, 533)
        HollowTri_Dialog.setMinimumSize(QSize(540, 529))
        HollowTri_Dialog.setMaximumSize(QSize(540, 533))
        HollowTri_Dialog.setStyleSheet(u"*{	\n"
"	color: rgb(255, 255, 255);\n"
"	font: 9pt \"Segoe UI\";\n"
"	background-color: rgb(43, 43, 43);\n"
"}\n"
"")
        self.gridLayout_3 = QGridLayout(HollowTri_Dialog)
        ...
        self.label = QLabel(HollowTri_Dialog)
        ...
        self.ModelingType_groupBox = QGroupBox(HollowTri_Dialog)
        ...
        self.Dimension_groupBox = QGroupBox(HollowTri_Dialog)
...
"")
        ...
        self.B1_lineEdit = QLineEdit(self.Dimension_groupBox)
        self.B1_lineEdit.setObjectName(u"B1_lineEdit")
        self.B1_lineEdit.setStyleSheet(u"*{	\n"
"	font: 9pt \"Segoe UI\";\n"
"	color: rgb(0, 0, 0);\n"
"	background: rgb(255, 255, 255);\n"
"}\n"
"")
        ...
        self.formLayout.setWidget(1, QFormLayout.FieldRole, self.B1_lineEdit)
...
"")
        ...
        self.tw_lineEdit = QLineEdit(self.Dimension_groupBox)
        self.tw_lineEdit.setObjectName(u"tw_lineEdit")
        self.tw_lineEdit.setStyleSheet(u"*{	\n"
"	font: 9pt \"Segoe UI\";\n"
"	color: rgb(0, 0, 0);\n"
"	background: rgb(255, 255, 255);\n"
"}\n"
"")
        ...
        self.formLayout.setWidget(3, QFormLayout.FieldRole, self.tw_lineEdit)
        ...
        self.HollowTri_groupBox = QGroupBox(HollowTri_Dialog)
        self.HollowTri_groupBox.setObjectName(u"HollowTri_groupBox")
        self.HollowTri_groupBox.setMinimumSize(QSize(0, 80))
        self.HollowTri_groupBox.setStyleSheet(u"color: rgb(255, 255, 255);\n"
"background-color: rgb(128, 128, 128);")
        self.gridLayout_2 = QGridLayout(self.HollowTri_groupBox)
...
"")
        ...
        self.fy_inputlineEdit = QLineEdit(self.HollowTri_groupBox)
...
"")
        ...
        self.eu_label = QLabel(self.HollowTri_groupBox)
        self.eu_label.setObjectName(u"eu_label")

        self.gridLayout.addWidget(self.eu_label, 1, 4, 1, 1)

        self.G_inputlineEdit = QLineEdit(self.HollowTri_groupBox)
...
"")
        ...
        self.E_inputlineEdit = QLineEdit(self.HollowTri_groupBox)
...
"")
        ...
        self.ID_inputlineEdit = QLineEdit(self.HollowTri_groupBox)
...
"")
        ...
        self.ColorButton = QPushButton(self.HollowTri_groupBox)
...
"")
        ...
        self.gridLayout_3.addWidget(self.HollowTri_groupBox, 0, 0, 1, 1)

        self.button_GroupBox = QGroupBox(HollowTri_Dialog)
...
"")
        ...
        QWidget.setTabOrder(self.B_inputlineEdit, self.B1_lineEdit)
        QWidget.setTabOrder(self.B1_lineEdit, self.D_inputlineEdit)
        QWidget.setTabOrder(self.D_inputlineEdit, self.tw_lineEdit)
        QWidget.setTabOrder(self.tw_lineEdit, self.Import_pushButton)
        ...
        self.retranslateUi(HollowTri_Dialog)

        QMetaObject.connectSlotsByName(HollowTri_Dialog)
    # setupUi

    def retranslateUi(self, HollowTri_Dialog):
        HollowTri_Dialog.setWindowTitle(QCoreApplication.translate("HollowTri_Dialog", u"Hollow Triangle - Template", None))
        self.label.setText("")
        self.ModelingType_groupBox.setTitle(QCoreApplication.translate("HollowTri_Dialog", u"Modeling Type", None))
        self.Centerline_radioButton.setText(QCoreApplication.translate("HollowTri_Dialog", u"Centerline", None))
        self.Outline_radioButton.setText(QCoreApplication.translate("HollowTri_Dialog", u"Outline", None))
        self.Dimension_groupBox.setTitle(QCoreApplication.translate("HollowTri_Dialog", u"Dimension", None))
        self.B_label.setText(QCoreApplication.translate("HollowTri_Dialog", u"B = ", None))
        self.tw_label.setText(QCoreApplication.translate("HollowTri_Dialog", u"D = ", None))
        self.label_2.setText(QCoreApplication.translate("HollowTri_Dialog", u"B1 = ", None))
        self.label_3.setText(QCoreApplication.translate("HollowTri_Dialog", u"tw = ", None))
        self.HollowTri_groupBox.setTitle(QCoreApplication.translate("HollowTri_Dialog", u"Material", None))
        self.G_label.setText(QCoreApplication.translate("HollowTri_Dialog", u" E  = ", None))
        self.ID_label.setText(QCoreApplication.translate("HollowTri_Dialog", u"Color = ", None))
        self.E_label.setText(QCoreApplication.translate("HollowTri_Dialog", u"ID = ", None))
        self.fy_label.setText(QCoreApplication.translate("HollowTri_Dialog", u"fy  = ", None))
        self.Color_label.setText(QCoreApplication.translate("HollowTri_Dialog", u"     \u03bc   = ", None))
        self.eu_label.setText(QCoreApplication.translate("HollowTri_Dialog", u"eu = ", None))
        self.ColorButton.setText("")
        self.Import_pushButton.setText(QCoreApplication.translate("HollowTri_Dialog", u"Import", None))
        self.OK_button.setText(QCoreApplication.translate("HollowTri_Dialog", u"OK", None))
        self.Cancel_pushButton.setText(QCoreApplication.translate("HollowTri_Dialog", u"Cancel", None))
    # retranslateUi
