# Form implementation generated from reading ui file 'CSectionDb.ui'
#
...
class Ui_CSectionDb_Dialog(object):
    def setupUi(self, CSectionDb_Dialog):
        CSectionDb_Dialog.setObjectName("CSectionDb_Dialog")
        CSectionDb_Dialog.resize(447, 561)
        CSectionDb_Dialog.setStyleSheet("*{    \n"
"    color: rgb(255, 255, 255);\n"
"    font: 9pt \"Segoe UI\";\n"
"    background-color: rgb(43, 43, 43);\n"
"}\n"
"")
        self.verticalLayout = QtWidgets.QVBoxLayout(CSectionDb_Dialog)
        ...
        self.CSection_groupBox = QtWidgets.QGroupBox(CSectionDb_Dialog)
...
"")
        ...
        self.groupBox = QtWidgets.QGroupBox(CSectionDb_Dialog)
...
"}")
        ...
        self.retranslateUi(CSectionDb_Dialog)
        QtCore.QMetaObject.connectSlotsByName(CSectionDb_Dialog)

    def retranslateUi(self, CSectionDb_Dialog):
        _translate = QtCore.QCoreApplication.translate
        CSectionDb_Dialog.setWindowTitle(_translate("CSectionDb_Dialog", "C-Section - Database"))
        self.CSection_groupBox.setTitle(_translate("CSectionDb_Dialog", "Database"))
        self.ComboBox.setItemText(0, _translate("CSectionDb_Dialog", "AISC(mm)"))
        self.ComboBox.setItemText(1, _translate("CSectionDb_Dialog", "AISC(in)"))
        self.groupBox_3.setTitle(_translate("CSectionDb_Dialog", "Section name:"))
        self.groupBox_2.setTitle(_translate("CSectionDb_Dialog", "Dimensions:"))
        self.OK_button.setText(_translate("CSectionDb_Dialog", "OK"))
        self.Cancel_pushButton.setText(_translate("CSectionDb_Dialog", "Cancel"))
