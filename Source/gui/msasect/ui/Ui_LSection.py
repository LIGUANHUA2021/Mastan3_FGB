...
################################################################################
## Form generated from reading UI file 'LSection.ui'
##
...
class Ui_LSection_Dialog(object):
    def setupUi(self, LSection_Dialog):
        if not LSection_Dialog.objectName():
            LSection_Dialog.setObjectName(u"LSection_Dialog")
        LSection_Dialog.resize(540, 533)
        LSection_Dialog.setMinimumSize(QSize(540, 533))
        LSection_Dialog.setMaximumSize(QSize(540, 533))
        LSection_Dialog.setStyleSheet(u"*{	\n"
"	color: rgb(255, 255, 255);\n"
"	font: 9pt \"Segoe UI\";\n"
"	background-color: rgb(43, 43, 43);\n"
"}\n"
"")
        self.gridLayout_3 = QGridLayout(LSection_Dialog)
        ...
        self.label = QLabel(LSection_Dialog)
        ...
        self.ModelingType_groupBox = QGroupBox(LSection_Dialog)
        ...
        self.Dimension_groupBox = QGroupBox(LSection_Dialog)
...
"")
        ...
        self.LSection_groupBox = QGroupBox(LSection_Dialog)
        self.LSection_groupBox.setObjectName(u"LSection_groupBox")
        self.LSection_groupBox.setMinimumSize(QSize(0, 80))
        self.LSection_groupBox.setStyleSheet(u"color: rgb(255, 255, 255);\n"
"background-color: rgb(128, 128, 128);")
        self.gridLayout_2 = QGridLayout(self.LSection_groupBox)
...
"")
        ...
        self.fy_inputlineEdit = QLineEdit(self.LSection_groupBox)
...
"")
        ...
        self.eu_label = QLabel(self.LSection_groupBox)
        self.eu_label.setObjectName(u"eu_label")

        self.gridLayout.addWidget(self.eu_label, 1, 4, 1, 1)

        self.G_inputlineEdit = QLineEdit(self.LSection_groupBox)
...
"")
        ...
        self.E_inputlineEdit = QLineEdit(self.LSection_groupBox)
...
"")
        ...
        self.ID_inputlineEdit = QLineEdit(self.LSection_groupBox)
        ...
        self.ID_inputlineEdit.setFont(font)
...
"")
        ...
        self.ColorButton = QPushButton(self.LSection_groupBox)
...
"")
        ...
        self.gridLayout_3.addWidget(self.LSection_groupBox, 0, 0, 1, 1)

        self.button_GroupBox = QGroupBox(LSection_Dialog)
...
"")
        ...
        self.retranslateUi(LSection_Dialog)

        QMetaObject.connectSlotsByName(LSection_Dialog)
    # setupUi

    def retranslateUi(self, LSection_Dialog):
        LSection_Dialog.setWindowTitle(QCoreApplication.translate("LSection_Dialog", u"L-Section - Template", None))
        self.label.setText("")
        self.ModelingType_groupBox.setTitle(QCoreApplication.translate("LSection_Dialog", u"Modeling Type", None))
        self.Centerline_radioButton.setText(QCoreApplication.translate("LSection_Dialog", u"Centerline", None))
        self.Outline_radioButton.setText(QCoreApplication.translate("LSection_Dialog", u"Outline", None))
        self.Dimension_groupBox.setTitle(QCoreApplication.translate("LSection_Dialog", u"Dimension", None))
        self.B_label.setText(QCoreApplication.translate("LSection_Dialog", u"B  = ", None))
        self.D_label.setText(QCoreApplication.translate("LSection_Dialog", u"D  = ", None))
        self.tf_label.setText(QCoreApplication.translate("LSection_Dialog", u"t1 = ", None))
        self.tw_label.setText(QCoreApplication.translate("LSection_Dialog", u"t2 = ", None))
        self.label_2.setText(QCoreApplication.translate("LSection_Dialog", u"k = ", None))
        self.LSection_groupBox.setTitle(QCoreApplication.translate("LSection_Dialog", u"Material", None))
        self.G_label.setText(QCoreApplication.translate("LSection_Dialog", u" E  = ", None))
        self.ID_label.setText(QCoreApplication.translate("LSection_Dialog", u"Color = ", None))
        self.E_label.setText(QCoreApplication.translate("LSection_Dialog", u"ID = ", None))
        self.fy_label.setText(QCoreApplication.translate("LSection_Dialog", u"fy  = ", None))
        self.Color_label.setText(QCoreApplication.translate("LSection_Dialog", u"     \u03bc   = ", None))
        self.eu_label.setText(QCoreApplication.translate("LSection_Dialog", u"eu = ", None))
        self.ColorButton.setText("")
        self.Import_pushButton.setText(QCoreApplication.translate("LSection_Dialog", u"Import", None))
        self.OK_button.setText(QCoreApplication.translate("LSection_Dialog", u"OK", None))
        self.Cancel_pushButton.setText(QCoreApplication.translate("LSection_Dialog", u"Cancel", None))
    # retranslateUi
