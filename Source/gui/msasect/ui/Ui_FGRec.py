...
################################################################################
## Form generated from reading UI file 'FGRec.ui'
##
...
class Ui_FGRec_Dialog(object):
    def setupUi(self, FGRec_Dialog):
        if not FGRec_Dialog.objectName():
            FGRec_Dialog.setObjectName(u"FGRec_Dialog")
        FGRec_Dialog.resize(540, 555)
        FGRec_Dialog.setMinimumSize(QSize(540, 555))
        FGRec_Dialog.setMaximumSize(QSize(540, 555))
        FGRec_Dialog.setStyleSheet(u"*{	\n"
"	color: rgb(255, 255, 255);\n"
"	font: 9pt \"Segoe UI\";\n"
"	background-color: rgb(43, 43, 43);\n"
"}\n"
"")
        self.gridLayout_3 = QGridLayout(FGRec_Dialog)
        ...
        self.label = QLabel(FGRec_Dialog)
        ...
        self.ModelingType_groupBox = QGroupBox(FGRec_Dialog)
        ...
        self.Dimension_groupBox = QGroupBox(FGRec_Dialog)
...
"")
        ...
        self.FGRec_groupBox = QGroupBox(FGRec_Dialog)
        self.FGRec_groupBox.setObjectName(u"FGRec_groupBox")
        self.FGRec_groupBox.setMinimumSize(QSize(0, 80))
        self.FGRec_groupBox.setStyleSheet(u"color: rgb(255, 255, 255);\n"
"background-color: rgb(128, 128, 128);")
        self.gridLayout_2 = QGridLayout(self.FGRec_groupBox)
        ...
        self.label_3 = QLabel(self.FGRec_groupBox)
        self.label_3.setObjectName(u"label_3")

        self.gridLayout.addWidget(self.label_3, 0, 0, 1, 1)

        self.Color_label = QLabel(self.FGRec_groupBox)
        self.Color_label.setObjectName(u"Color_label")

        self.gridLayout.addWidget(self.Color_label, 2, 0, 1, 1)

        self.Law_comboBox = QComboBox(self.FGRec_groupBox)
...
"}")
        ...
        self.G_inputlineEdit = QLineEdit(self.FGRec_groupBox)
...
"")
        ...
        self.eu_label = QLabel(self.FGRec_groupBox)
        self.eu_label.setObjectName(u"eu_label")

        self.gridLayout.addWidget(self.eu_label, 0, 4, 1, 1)

        self.eu_inputlineEdit = QLineEdit(self.FGRec_groupBox)
...
"")
        ...
        self.E_label = QLabel(self.FGRec_groupBox)
        self.E_label.setObjectName(u"E_label")

        self.gridLayout.addWidget(self.E_label, 1, 0, 1, 1)

        self.Ei_inputlineEdit = QLineEdit(self.FGRec_groupBox)
...
"")
        ...
        self.G_label = QLabel(self.FGRec_groupBox)
        self.G_label.setObjectName(u"G_label")

        self.gridLayout.addWidget(self.G_label, 1, 2, 1, 1)

        self.E0_inputlineEdit = QLineEdit(self.FGRec_groupBox)
...
"")
        ...
        self.fy_label = QLabel(self.FGRec_groupBox)
        self.fy_label.setObjectName(u"fy_label")

        self.gridLayout.addWidget(self.fy_label, 1, 4, 1, 1)

        self.fy_inputlineEdit = QLineEdit(self.FGRec_groupBox)
...
"")
        ...
        self.label_2 = QLabel(self.FGRec_groupBox)
        self.label_2.setObjectName(u"label_2")

        self.gridLayout.addWidget(self.label_2, 0, 2, 1, 1)

        self.label_4 = QLabel(self.FGRec_groupBox)
        self.label_4.setObjectName(u"label_4")

        self.gridLayout.addWidget(self.label_4, 2, 2, 1, 1)

        self.Num_inputlineEdit = QLineEdit(self.FGRec_groupBox)
...
"")
        ...
        self.k_inputlineEdit = QLineEdit(self.FGRec_groupBox)
...
"")
        ...
        self.gridLayout_3.addWidget(self.FGRec_groupBox, 0, 0, 1, 1)

        self.button_GroupBox = QGroupBox(FGRec_Dialog)
...
"")
        ...
        self.retranslateUi(FGRec_Dialog)

        QMetaObject.connectSlotsByName(FGRec_Dialog)
    # setupUi

    def retranslateUi(self, FGRec_Dialog):
        FGRec_Dialog.setWindowTitle(QCoreApplication.translate("FGRec_Dialog", u"Functionally Graded Rectangular Solid Section - Template", None))
        self.label.setText("")
        self.ModelingType_groupBox.setTitle(QCoreApplication.translate("FGRec_Dialog", u"Modeling Type", None))
        self.Centerline_radioButton.setText(QCoreApplication.translate("FGRec_Dialog", u"Centerline", None))
        self.Outline_radioButton.setText(QCoreApplication.translate("FGRec_Dialog", u"Outline", None))
        self.Dimension_groupBox.setTitle(QCoreApplication.translate("FGRec_Dialog", u"Dimension", None))
        self.B_label.setText(QCoreApplication.translate("FGRec_Dialog", u"B = ", None))
        self.tw_label.setText(QCoreApplication.translate("FGRec_Dialog", u"D = ", None))
        self.FGRec_groupBox.setTitle(QCoreApplication.translate("FGRec_Dialog", u"Material", None))
        self.label_3.setText(QCoreApplication.translate("FGRec_Dialog", u"Gradation :", None))
        self.Color_label.setText(QCoreApplication.translate("FGRec_Dialog", u"     \u03bc   = ", None))
        self.Law_comboBox.setItemText(0, QCoreApplication.translate("FGRec_Dialog", u"Power law", None))
        self.Law_comboBox.setItemText(1, QCoreApplication.translate("FGRec_Dialog", u"Exponential law", None))
        self.Law_comboBox.setItemText(2, QCoreApplication.translate("FGRec_Dialog", u"Sigmoid law", None))

        self.eu_label.setText(QCoreApplication.translate("FGRec_Dialog", u" eu = ", None))
        self.E_label.setText(QCoreApplication.translate("FGRec_Dialog", u"     Ei = ", None))
        self.G_label.setText(QCoreApplication.translate("FGRec_Dialog", u"     E0 = ", None))
        self.fy_label.setText(QCoreApplication.translate("FGRec_Dialog", u" fy  = ", None))
        self.label_2.setText(QCoreApplication.translate("FGRec_Dialog", u"Strip Num =", None))
        self.label_4.setText(QCoreApplication.translate("FGRec_Dialog", u"     k =", None))
        self.OK_button.setText(QCoreApplication.translate("FGRec_Dialog", u"OK", None))
        self.Cancel_pushButton.setText(QCoreApplication.translate("FGRec_Dialog", u"Cancel", None))
    # retranslateUi
