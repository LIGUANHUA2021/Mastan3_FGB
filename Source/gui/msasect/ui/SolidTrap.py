...
import numpy as np
from gui.msasect.ui.Ui_SolidTrap import Ui_SolidTrap_Dialog
...
class SolidTrap_Dialog(QDialog, Ui_SolidTrap_Dialog):
    """
    ...
    def __init__(self, mw, parent=None):
        ...
        self.setupUi(self)
        self.setWindowIcon(QIcon('ui/ico/TemplateIcon/Solid Trap.ico'))
        self.color = '#aaffff'
    ...
    def initDialog(self):
        self.label.setPixmap(QPixmap("ui/Template/Solid Trap.jpg"))
        ...
        self.B2_inputlineEdit.setText(str(500))
        self.B3_inputlineEdit.setText(str(100))
    ...
    def on_OK_button_clicked(self):
        ...
        try:
            if len(self.E_inputlineEdit.text()) == 0 or len(self.G_inputlineEdit.text()) == 0 or len(
                    self.fy_inputlineEdit.text()) == 0 or len(self.B1_inputlineEdit.text()) == 0 or len(self.B2_inputlineEdit.text()) == 0 or len(self.B3_inputlineEdit.text()) == 0 or len(self.D_inputlineEdit.text()) == 0 :
                ...
                if B1<0 or B2<0 or B3<0 or D<0 or tE<0 or tμ<0 or tfy<0 or teu<0:
                    showMesbox(self, 'Please input correct data!')
                else:
                    if id in MatIdDict:
                        ...
                        msaFEModel.Point.Add(tID=3, ty=-D, tz=-B2+B3)
                        msaFEModel.Point.Add(tID=4, ty=-D, tz=B3)
                        ...
                        self.mw.SectIDInput_lineEdit.setText('SolidTrap01')
                        self.accept()
                        SectProperty.Reset()
