# Form implementation generated from reading ui file 'HollowCircleDb.ui'
#
...
class Ui_HollowCircleDb_Dialog(object):
    def setupUi(self, HollowCircleDb_Dialog):
        HollowCircleDb_Dialog.setObjectName("HollowCircleDb_Dialog")
        HollowCircleDb_Dialog.resize(447, 561)
        HollowCircleDb_Dialog.setStyleSheet("*{    \n"
"    color: rgb(255, 255, 255);\n"
"    font: 9pt \"Segoe UI\";\n"
"    background-color: rgb(43, 43, 43);\n"
"}\n"
"")
        self.verticalLayout = QtWidgets.QVBoxLayout(HollowCircleDb_Dialog)
        ...
        self.HollowCircle_groupBox = QtWidgets.QGroupBox(HollowCircleDb_Dialog)
...
"background-color: rgb(128, 128, 128);")
        ...
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.HollowCircle_groupBox)
        ...
        self.ComboBox = QtWidgets.QComboBox(self.HollowCircle_groupBox)
...
"}")
        ...
        self.groupBox_3 = QtWidgets.QGroupBox(self.HollowCircle_groupBox)
        ...
        self.label = QtWidgets.QLabel(self.HollowCircle_groupBox)
...
"")
        ...
        self.groupBox_2 = QtWidgets.QGroupBox(self.HollowCircle_groupBox)
        ...
        self.verticalLayout.addWidget(self.HollowCircle_groupBox)
        ...
        self.groupBox = QtWidgets.QGroupBox(HollowCircleDb_Dialog)
...
"}")
        ...
        self.retranslateUi(HollowCircleDb_Dialog)
        QtCore.QMetaObject.connectSlotsByName(HollowCircleDb_Dialog)

    def retranslateUi(self, HollowCircleDb_Dialog):
        _translate = QtCore.QCoreApplication.translate
        HollowCircleDb_Dialog.setWindowTitle(_translate("HollowCircleDb_Dialog", "Hollow Circle - Database"))
        self.HollowCircle_groupBox.setTitle(_translate("HollowCircleDb_Dialog", "Database"))
        self.ComboBox.setItemText(0, _translate("HollowCircleDb_Dialog", "AISC(mm)"))
        self.ComboBox.setItemText(1, _translate("HollowCircleDb_Dialog", "AISC(in)"))
        self.groupBox_3.setTitle(_translate("HollowCircleDb_Dialog", "Section name:"))
        self.groupBox_2.setTitle(_translate("HollowCircleDb_Dialog", "Dimensions:"))
        self.OK_button.setText(_translate("HollowCircleDb_Dialog", "OK"))
        self.Cancel_pushButton.setText(_translate("HollowCircleDb_Dialog", "Cancel"))
