...
################################################################################
## Form generated from reading UI file 'TSection.ui'
##
...
class Ui_TSection_Dialog(object):
    def setupUi(self, TSection_Dialog):
        if not TSection_Dialog.objectName():
            TSection_Dialog.setObjectName(u"TSection_Dialog")
        TSection_Dialog.resize(540, 533)
        TSection_Dialog.setMinimumSize(QSize(540, 533))
        TSection_Dialog.setMaximumSize(QSize(540, 533))
        TSection_Dialog.setStyleSheet(u"*{	\n"
"	color: rgb(255, 255, 255);\n"
"	font: 9pt \"Segoe UI\";\n"
"	background-color: rgb(43, 43, 43);\n"
"}\n"
"")
        self.gridLayout_3 = QGridLayout(TSection_Dialog)
        ...
        self.label = QLabel(TSection_Dialog)
        ...
        self.ModelingType_groupBox = QGroupBox(TSection_Dialog)
        ...
        self.Dimension_groupBox = QGroupBox(TSection_Dialog)
...
"")
        ...
        self.formLayout.setWidget(2, QFormLayout.FieldRole, self.t1_inputlineEdit)
...
"")
        ...
        self.formLayout.setWidget(3, QFormLayout.FieldRole, self.t2_inputlineEdit)
...
"")
        ...
        self.TSection_groupBox = QGroupBox(TSection_Dialog)
        self.TSection_groupBox.setObjectName(u"TSection_groupBox")
        self.TSection_groupBox.setMinimumSize(QSize(0, 80))
        self.TSection_groupBox.setStyleSheet(u"color: rgb(255, 255, 255);\n"
"background-color: rgb(128, 128, 128);")
        self.gridLayout_2 = QGridLayout(self.TSection_groupBox)
        self.gridLayout_2.setObjectName(u"gridLayout_2")
        self.gridLayout_2.setContentsMargins(9, 4, 9, -1)
        self.gridLayout = QGridLayout()
        self.gridLayout.setSpacing(6)
        self.gridLayout.setObjectName(u"gridLayout")
        self.gridLayout.setContentsMargins(2, 2, 2, 2)
        self.G_label = QLabel(self.TSection_groupBox)
        self.G_label.setObjectName(u"G_label")

        self.gridLayout.addWidget(self.G_label, 0, 4, 1, 1)

        self.ID_label = QLabel(self.TSection_groupBox)
        self.ID_label.setObjectName(u"ID_label")

        self.gridLayout.addWidget(self.ID_label, 0, 0, 1, 1)

        self.E_label = QLabel(self.TSection_groupBox)
        self.E_label.setObjectName(u"E_label")

        self.gridLayout.addWidget(self.E_label, 0, 2, 1, 1)

        self.fy_label = QLabel(self.TSection_groupBox)
        self.fy_label.setObjectName(u"fy_label")

        self.gridLayout.addWidget(self.fy_label, 1, 2, 1, 1)

        self.Color_label = QLabel(self.TSection_groupBox)
        self.Color_label.setObjectName(u"Color_label")

        self.gridLayout.addWidget(self.Color_label, 1, 0, 1, 1)

        self.eu_inputlineEdit = QLineEdit(self.TSection_groupBox)
...
"")
        ...
        self.fy_inputlineEdit = QLineEdit(self.TSection_groupBox)
...
"")
        ...
        self.eu_label = QLabel(self.TSection_groupBox)
        self.eu_label.setObjectName(u"eu_label")

        self.gridLayout.addWidget(self.eu_label, 1, 4, 1, 1)

        self.G_inputlineEdit = QLineEdit(self.TSection_groupBox)
...
"")
        ...
        self.E_inputlineEdit = QLineEdit(self.TSection_groupBox)
...
"")
        ...
        self.ID_inputlineEdit = QLineEdit(self.TSection_groupBox)
...
"")
        ...
        self.ColorButton = QPushButton(self.TSection_groupBox)
        self.ColorButton.setObjectName(u"ColorButton")
        self.ColorButton.setMinimumSize(QSize(0, 18))
...
"")
        ...
        self.gridLayout_3.addWidget(self.TSection_groupBox, 0, 0, 1, 1)

        self.button_GroupBox = QGroupBox(TSection_Dialog)
...
"")
        ...
        QWidget.setTabOrder(self.t2_inputlineEdit, self.k_inputlineEdit)
        ...
        self.retranslateUi(TSection_Dialog)

        QMetaObject.connectSlotsByName(TSection_Dialog)
    # setupUi

    def retranslateUi(self, TSection_Dialog):
        TSection_Dialog.setWindowTitle(QCoreApplication.translate("TSection_Dialog", u"T-Section - Template", None))
        self.label.setText("")
        self.ModelingType_groupBox.setTitle(QCoreApplication.translate("TSection_Dialog", u"Modeling Type", None))
        self.Centerline_radioButton.setText(QCoreApplication.translate("TSection_Dialog", u"Centerline", None))
        self.Outline_radioButton.setText(QCoreApplication.translate("TSection_Dialog", u"Outline", None))
        self.Dimension_groupBox.setTitle(QCoreApplication.translate("TSection_Dialog", u"Dimension", None))
        self.B_label.setText(QCoreApplication.translate("TSection_Dialog", u"B = ", None))
        self.D_label.setText(QCoreApplication.translate("TSection_Dialog", u"D = ", None))
        self.tf_label.setText(QCoreApplication.translate("TSection_Dialog", u"t1 = ", None))
        self.tw_label.setText(QCoreApplication.translate("TSection_Dialog", u"t2 = ", None))
        self.label_2.setText(QCoreApplication.translate("TSection_Dialog", u"k = ", None))
        self.TSection_groupBox.setTitle(QCoreApplication.translate("TSection_Dialog", u"Material", None))
        self.G_label.setText(QCoreApplication.translate("TSection_Dialog", u" E  = ", None))
        self.ID_label.setText(QCoreApplication.translate("TSection_Dialog", u"Color = ", None))
        self.E_label.setText(QCoreApplication.translate("TSection_Dialog", u"ID = ", None))
        self.fy_label.setText(QCoreApplication.translate("TSection_Dialog", u"fy  = ", None))
        self.Color_label.setText(QCoreApplication.translate("TSection_Dialog", u"     \u03bc   = ", None))
        self.eu_label.setText(QCoreApplication.translate("TSection_Dialog", u"eu = ", None))
        self.ColorButton.setText("")
        self.Import_pushButton.setText(QCoreApplication.translate("TSection_Dialog", u"Import", None))
        self.OK_button.setText(QCoreApplication.translate("TSection_Dialog", u"OK", None))
        self.Cancel_pushButton.setText(QCoreApplication.translate("TSection_Dialog", u"Cancel", None))
    # retranslateUi
