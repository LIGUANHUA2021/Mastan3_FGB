...
from gui.msasect.ui.Ui_CSectionDb import Ui_CSectionDb_Dialog
...
class CSectionDb_Dialog(QDialog, Ui_CSectionDb_Dialog):
    """
    ...
    def initlize(self):
        self.label.setPixmap(QPixmap("ui/Template/C-Section_Db.jpg"))
