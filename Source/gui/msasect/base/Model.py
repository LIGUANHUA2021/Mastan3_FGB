...
class msaFEModel:
    ...
    class Mat:
        ...
        def Add_gra(GID: int, E_ref: float, E_begin: float, E_end: float, Gra_ang: float, Gra_law: float, GColor: str):
            ...
            msaFEModel.Mat.Gra_ang = Gra_law
            msaFEModel.Mat.Gra_ang = GColor
